...
SELECT pk_entity,
    fk_project
FROM pgwar.get_outdated_full_texts_in_objects_of_stmt_del(100);

-- Note that (13, 543), (13, 0) is an object_value and does therefore
...
FROM pgwar.get_outdated_full_texts_in_objects_of_stmt_del(3);
