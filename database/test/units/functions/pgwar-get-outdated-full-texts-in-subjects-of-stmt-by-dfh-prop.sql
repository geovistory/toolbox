...
SELECT pk_entity,
    fk_project
FROM pgwar.get_outdated_full_texts_in_subjects_of_stmt_by_dfh_prop(100);
...
-- Update two dfh-properties
INSERT INTO data_for_history.api_property(
        tmsp_last_dfh_update,
        dfh_pk_property
    )
VALUES (clock_timestamp(), 523),
(clock_timestamp(), 524);

SELECT bag_eq(
        'entities_for_update',
        'VALUES (32, 999), (33, 543), (32, 0), (33, 0)',
...
FROM pgwar.get_outdated_full_texts_in_subjects_of_stmt_by_dfh_prop(1);
