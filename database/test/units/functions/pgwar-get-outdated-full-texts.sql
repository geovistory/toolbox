...
SELECT pk_entity,
    fk_project
FROM pgwar.get_outdated_full_texts(5);

SELECT bag_eq(
        'entities_for_update',
        'VALUES (31, 123), (11, 123), (32, 999), (12, 999), (33, 543)',
        'Contains all 5 pairs of project_id and subject entity_id.'
    );
...
FROM pgwar.get_outdated_full_texts(3);
