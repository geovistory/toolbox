...
exports.up = function(db, callback) {
  ...
  DROP CONSTRAINT persistent_item_fk_class_fkey;

  -- Drop view depending on persistent_item/fk_class
  ...
  ALTER TABLE information.persistent_item
  ADD CONSTRAINT persistent_item_fk_class_fkey
  ...
  ALTER TABLE information.persistent_item_vt
  ALTER COLUMN fk_class TYPE integer USING NULL;
