-- 1
ALTER TABLE projects.info_proj_rel ADD COLUMN project_visibility JSONB;
ALTER TABLE projects.info_proj_rel_vt ADD COLUMN project_visibility JSONB;
