...
DROP COLUMN dfh_property_inverse_label;

ALTER TABLE data_for_history.api_property_vt
DROP COLUMN dfh_property_inverse_label;

-- 1
ALTER TABLE data_for_history.class_profile_view_deprecated RENAME TO class_profile_view;
ALTER TABLE data_for_history.class_profile_view_vt_deprecated RENAME TO class_profile_view_vt;
ALTER TABLE data_for_history.associates_system_type_deprecated RENAME TO associates_system_type;
ALTER TABLE data_for_history.associates_system_type_vt_deprecated RENAME TO associates_system_type_vt;
ALTER TABLE data_for_history.label_deprecated RENAME TO label;
ALTER TABLE data_for_history.label_vt_deprecated RENAME TO label_vt;
ALTER TABLE data_for_history.property_profile_view_deprecated RENAME TO property_profile_view;
ALTER TABLE data_for_history.property_profile_view_vt_deprecated RENAME TO property_profile_view_vt;
ALTER TABLE data_for_history.system_type_deprecated RENAME TO system_type;
ALTER TABLE data_for_history.system_type_vt_deprecated RENAME TO system_type_vt;
ALTER TABLE data_for_history.text_property_deprecated RENAME TO text_property;
ALTER TABLE data_for_history.text_property_vt_deprecated RENAME TO text_property_vt;
