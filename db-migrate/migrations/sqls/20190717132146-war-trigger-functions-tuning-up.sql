-- 1 helper function to check if entity is peit or teen
CREATE FUNCTION information.is_persistent_item_or_temporal_entity (integer)
  RETURNS BOOLEAN
  AS $$
  SELECT
    EXISTS (
...
-- 2 remove calls that tried to create previews for languages and appellations
