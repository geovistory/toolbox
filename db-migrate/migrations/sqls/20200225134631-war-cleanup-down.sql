-- 5
Create Or Replace Function war.edges__delete_some (
    ...
    Where fk_role = Any (param_pk_roles)
        And (fk_project Is Null
            Or fk_project = param_fk_project)
    Returning
        *;
...
-- 4
Create Or Replace Function war.nodes__delete_some (
    param_pk_entities integer[],
    param_fk_project integer
)
    Returns Setof war.node
    Language 'sql'
    Cost 100 Volatile Rows 1000
    As $BODY$
    /**
...
-- 2
Create Or Replace Function war.nodes__create_some (
    param_pk_entities integer[],
    param_fk_project integer
)
    Returns Setof war.node
...
-- 1
Create Or Replace Function war.nodes__create_all ()
    Returns Setof war.node
    Language 'sql'
    Cost 100 Volatile Rows 1000
    As $BODY$
...
-- 3
Create Or Replace Function war.nodes__upsert_some (
    param_pk_entities integer[],
    param_fk_project integer
)
    Returns Setof war.node
    ...
    Select
        war.nodes__delete_some (param_pk_entities,
            param_fk_project);
...
Select
    *
From
    war.nodes__create_some (param_pk_entities,
        param_fk_project)
Returning
    *;
