...
exports.up = function(db, callback) {
  ...
  DROP CONSTRAINT appellation_fk_class_fkey;

  -- Drop view depending on appellation/fk_class

  DROP TRIGGER IF EXISTS on_insert ON information.v_appellation_version;
  DROP FUNCTION IF EXISTS information.v_appellation_version_insert();
  DROP VIEW IF EXISTS information.v_appellation_version;
  ...
  ALTER TABLE information.appellation
  ADD CONSTRAINT appellation_fk_class_fkey
  ...
  ALTER TABLE information.appellation_vt
  ALTER COLUMN fk_class TYPE integer USING NULL;

  -- Create the view again


  CREATE OR REPLACE VIEW information.v_appellation_version AS
  WITH versions AS (
    ...
    tmsp_last_modification,
    sys_period
    FROM information.appellation_vt
  ), statistics AS (
    SELECT DISTINCT
    pk_entity,
    pk_appellation,
    ...
    INSTEAD OF INSERT
    ON information.v_appellation_version
    FOR EACH ROW
    EXECUTE PROCEDURE information.v_appellation_version_insert();
    `
