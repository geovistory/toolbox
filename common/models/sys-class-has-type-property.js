...
module.exports = function (SysClassHasTypeProperty) {
    SysClassHasTypeProperty.readableList = function (cb) {
        const sql_stmt = `
        select 
        ...
        from system.class_has_type_property ctp
        ...
        `
        const connector = SysClassHasTypeProperty.dataSource.connector;
