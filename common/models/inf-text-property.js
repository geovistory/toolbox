...
module.exports = function (InfTextProperty) {
  ...
  InfTextProperty.findOrCreateInfTextProperties = function (pk_project, items, ctx) {
  ...
  InfTextProperty.findAlternativeTextProperties = function (pkProject, pkEntity, pkClassField, ctx, cb) {

    const columns = [...InfTextProperty.definition._ids.map(id => id.name), ...Object.keys(InfTextProperty.definition.properties)]
