 ...
 */
export class SqlGvGetOutgoingStatementsToAdd extends SqlBuilderLb4Models {
  generateFunctionSql() {
    this.sql = `
    DROP FUNCTION IF EXISTS gv_get_outgoing_statements_to_add;
    CREATE FUNCTION gv_get_outgoing_statements_to_add(
        properties jsonb,
        entity_id integer)
