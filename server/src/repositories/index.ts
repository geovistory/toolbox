...
export * from './dat-class-column-mapping.repository';
export * from './dat-column.repository';
export * from './dat-digital.repository';
export * from './dat-factoid-mapping.repository';
export * from './dat-factoid-property-mapping.repository';
...
export * from './inf-resource.repository';
...
export * from './war-statement.repository';
