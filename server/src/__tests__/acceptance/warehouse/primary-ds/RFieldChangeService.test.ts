...
import {PFieldChangeId, RFieldChangeService} from '../../../../warehouse/primary-ds/RFieldChangeService';
...
const stubs: WarehouseStubs = {
  primaryDataServices: [RFieldChangeService],
  aggDataServices: []
}
describe('RFieldChangeService', () => {

  let wh: Warehouse;
  let s: RFieldChangeService;
  ...
  before(async function () {
    ...
    s = injector.get(RFieldChangeService)
  })
  beforeEach(async () => {
    await cleanDb()
