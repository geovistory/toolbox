...
export async function createDatFactoidMapping(factoidMapping: Partial<DatFactoidMapping>) {
    ...
    await TestDbFactory.datasource.execute(`INSERT INTO data.factoid_mapping (pk_entity, fk_digital, fk_class)
...
export async function createDatFactoidPropertyMapping(factoidPropertyMapping: Partial<DatFactoidPropertyMapping>) {
    ...
    await TestDbFactory.datasource.execute(`INSERT INTO data.factoid_property_mapping (pk_entity, fk_property, fk_column, fk_factoid_mapping)
