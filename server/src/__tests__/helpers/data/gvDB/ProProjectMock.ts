...
export class ProProjectMock {
  ...
  static readonly DEFAULT_PROJECT: Partial<ProProject> = ({
    pk_entity: PK_DEFAULT_CONFIG_PROJECT,
    fk_language: InfLanguageMock.GERMAN.pk_entity
  })

  static readonly PROJECT_1: Partial<ProProject> = ({
    pk_entity: 3001,
    fk_language: InfLanguageMock.GERMAN.pk_entity
  })

  static readonly PROJECT_2: Partial<ProProject> = ({
    pk_entity: 3002,
    fk_language: InfLanguageMock.ENGLISH.pk_entity
  })

  static readonly PROJECT_3: Partial<ProProject> = ({
    pk_entity: 3003,
    fk_language: InfLanguageMock.ENGLISH.pk_entity
  })

  static readonly SANDBOX_PROJECT: Partial<ProProject> = ({
    pk_entity: 375232,
    fk_language: InfLanguageMock.ENGLISH.pk_entity
  })
