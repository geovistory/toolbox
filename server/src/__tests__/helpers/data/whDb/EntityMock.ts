import { Entity } from '../../../../warehouse/primary-ds/EntityService';
...
export class EntityMock {
    ...
    static readonly NAME_1: Entity = {
        fkProject: 591,
        pkEntity: 22,
        fkClass: 365,
    };
    static readonly NAME_1_ID: EntityId = {
    ...
    static readonly NAME_2: Entity = {
        fkProject: 591,
        pkEntity: 23,
        fkClass: 365,
    };
    static readonly NAME_2_ID: EntityId = {
        fkProject: EntityMock.NAME_2.fkProject,
        pkEntity: EntityMock.NAME_2.pkEntity
    };

    // Naming 3
    static readonly NAME_3: Entity = {
        fkProject: 591,
        pkEntity: 24,
        fkClass: 365,
    }
    static readonly NAME_3_ID: EntityId = {
    ...
    static readonly PERS_1: Entity = {
        fkProject: 591,
        pkEntity: 33,
        fkClass: 21,
    };
    static readonly PERS_1_ID: EntityId = {
    ...
    // Person 2
    static readonly PERS_2: Entity = {
        fkProject: 591,
        pkEntity: 34,
        fkClass: 21,
    }
    static readonly PERS_2_ID: EntityId = {
    ...
    // Person 3
    static readonly PERS_3: Entity = {
        fkProject: 591,
        pkEntity: 35,
        fkClass: 21,
    }
    static readonly PERS_3_ID: EntityId = {
    ...
    // Birth 1
    static readonly BIRTH_1: Entity = {
        fkProject: 591,
        pkEntity: 41,
        fkClass: 61,
    }
    static readonly BIRTH_1_ID: EntityId = {
    ...
    // UNION 1
    static readonly UNION_1: Entity = {
        fkProject: 591,
        pkEntity: 51,
        fkClass: 66, // ??
    }
    static readonly UNION_1_ID: EntityId = {
