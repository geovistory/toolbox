...
import { PROFILE_4_GEOVISTORY_GENE_2022_01_27 } from '../data/ontome-profiles/profile-4-geovistory-gene-2022-01-27';
...
export async function initDBWithGaetan(): Promise<{ projectID: number, namespaceID: number, accountID: number }> {
  ...
  const profiles = await createOntomeProfileMock(PROFILE_4_GEOVISTORY_GENE_2022_01_27)
  const profiles2 = await createOntomeProfileMock(PROFILE_5_GEOVISTORY_BASI_2022_01_14)
  const profiles3 = await createOntomeProfileMock(PROFILE_12_BIOGRAPHICAL_BA_2022_01_14)
