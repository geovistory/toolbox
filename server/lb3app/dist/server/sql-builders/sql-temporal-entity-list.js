...
class SqlTemporalEntityList extends sql_builder_lb_models_1.SqlBuilderLbModels {
    ...
    create(fkProject, fkSourceEntity, fkProperty, fkTargetClass, isOutgoing, limit, offset) {
      ...
      t1.${isOutgoing ? 'fk_subject_info' : 'fk_object_info'} = ${this.addParam(fkSourceEntity)} --  add the pk_entity of the 'source' entity here
...
//# sourceMappingURL=sql-temporal-entity-list.js.map