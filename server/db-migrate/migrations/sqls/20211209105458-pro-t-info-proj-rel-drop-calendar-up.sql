...
-- 3
ALTER TABLE projects.info_proj_rel RENAME COLUMN calendar TO calendar_backup;

ALTER TABLE projects.info_proj_rel_vt RENAME COLUMN calendar TO calendar_backup;
