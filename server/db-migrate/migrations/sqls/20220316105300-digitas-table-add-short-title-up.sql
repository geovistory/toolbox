-- select tables and entity labels and default language of project
CREATE TEMP TABLE table_labels ON COMMIT DROP AS
SELECT
...
SELECT
  ...
  1761,
  t2.pk_entity,
  json_build_object('id', 'digitals_7', 'created', 'By Jonas Schneider for Digitals', 'fkProject', t1.fk_project)
FROM
  table_labels t1,
