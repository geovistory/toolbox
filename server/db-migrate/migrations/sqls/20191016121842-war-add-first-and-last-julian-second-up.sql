-- 1
ALTER TABLE warehouse.entity_preview_non_recursive ADD COLUMN first_second bigint;
ALTER TABLE warehouse.entity_preview_non_recursive ADD COLUMN last_second bigint;

-- 2
ALTER TABLE warehouse.entity_preview ADD COLUMN first_second bigint;
ALTER TABLE warehouse.entity_preview ADD COLUMN last_second bigint;
   ...
   -- 1
    ...
    tw9 AS (
        ...
        SELECT
          ...
          commons.time_primitive__get_last_second(t1.julian_day, t1.duration, 'gregorian') as last_second_julian,
          commons.time_primitive__get_last_second(t1.julian_day, t1.duration, 'julian') as last_second_gregorian
...
-- 8 data manipulation: update all entity_preview_non_recursive
