...
var exclude = [];
var include = ["InfPersistentItem", "InfRole", "InfAppellation","InfTemporalEntity", "InfLanguage", "Project", "InfEntityAssociation", "InfChunk", "InfDigitalObject", "InfPlace"];
  ...
  models.forEach(function(model){
    ...
    if(exclude.indexOf(modelName) == -1 && adapter == 'postgresql' && (include.length == 0 || include.indexOf(modelName) != -1)){
      ...
      model.remoteMethod('findComplex', {
        ...
        accepts: {arg: 'filter', type: 'object', "http": {
          "source": "body"
        }},
