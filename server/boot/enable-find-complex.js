...
} = require('../../node_modules/loopback-setup-remote-methods-mixin/lib/utils');
var exclude = [];
var include = [
  'SysAppContext',
  'ProClassFieldConfig',
...
module.exports = function(app) {
  ...
  models.forEach(function(model) {
    ...
    if (
      exclude.indexOf(modelName) == -1 &&
      adapter == 'postgresql' &&
      (include.length == 0 || include.indexOf(modelName) != -1)
    ) {
      ...
      const isAuthorized =
        getAuthorizedAclMethods(model).indexOf('findComplex') > -1;
