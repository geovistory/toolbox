...
exports.up = function (db, callback) {
  ...
  CREATE TABLE commons.property_set_class_rel (
  ...
  ON commons.property_set_class_rel FOR EACH ROW
  ...
  CREATE TABLE commons.property_set_class_rel_vt (LIKE commons.property_set_class_rel);

  CREATE TRIGGER versioning_trigger
  BEFORE INSERT OR UPDATE OR DELETE ON commons.property_set_class_rel
  FOR EACH ROW EXECUTE PROCEDURE versioning(
    'sys_period', 'commons.property_set_class_rel_vt', true
  );
  `
...
exports.down = function (db, callback) {
  const sql = `
  DROP TABLE IF EXISTS commons.property_set_class_rel CASCADE;
  DROP TABLE IF EXISTS commons.property_set_class_rel_vt CASCADE;
  `
  db.runSql(sql, callback)
};
