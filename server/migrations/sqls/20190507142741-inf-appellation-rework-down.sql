...
-- 3
DROP TRIGGER _02_find_or_create ON information.v_appellation;
...
CREATE OR REPLACE VIEW information.v_appellation AS
 SELECT appellation.pk_entity,
    ...
    appellation._deprecated_pk_appellation AS pk_appellation,
    appellation._deprecated_appellation_label AS appellation_label,
    appellation.fk_class,
    information.appellation_label_to_string(appellation._deprecated_appellation_label) AS string
