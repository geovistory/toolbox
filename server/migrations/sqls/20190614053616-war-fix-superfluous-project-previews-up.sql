    ...
    DECLARE
      ...
      BEGIN
        ...
        ELSIF (SELECT _table_name = 'role') THEN
          ...
          select is_in_project into _domain_is_in_project
          FROM projects.info_proj_rel
          Where fk_entity = _fk_temporal_entity AND fk_project = _fk_project;

          select is_in_project into _range_is_in_project
          FROM projects.info_proj_rel
          Where fk_entity = _fk_entity AND fk_project = _fk_project;
