...
tw3 As (
    Select
        ...
        Case When t1.property_is_outgoing = True Then
            t2.dfh_has_domain
        When t1.property_is_outgoing = False Then
            t2.dfh_has_range
        Else
    ...
    Left Join data_for_history.property t2 On t2.dfh_pk_property = t1.fk_property
    Left Join system.class_field t3 On t3.pk_entity = t1.fk_class_field
Where
