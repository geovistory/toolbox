...
From
    data_for_history.property p
    Join projects.class_field_config ctxt On p.dfh_pk_property = ctxt.fk_property
Where
    ctxt.fk_app_context = 47
...
From
    data_for_history.property p
    Join system.class_field_property_rel psprel On psprel.fk_property = p.dfh_pk_property
