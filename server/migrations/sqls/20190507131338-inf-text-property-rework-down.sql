...
-- -- 3.
DROP TRIGGER _02_find_or_create ON information.v_text_property;
...
ALTER FUNCTION information.v_text_property_find_or_create()
    OWNER TO postgres;
...
CREATE OR REPLACE VIEW information.v_text_property AS
 SELECT text_property.pk_entity,
    ...
    text_property._deprecated_text_property AS text_property,
    text_property.fk_concerned_entity,
    text_property._deprecated_text_property_quill_doc AS text_property_quill_doc,
    text_property.fk_language,
    text_property.fk_class_field,
    information.text_property_to_string(text_property._deprecated_text_property_quill_doc) AS string,
  ...
  GROUP BY text_property.pk_entity, text_property.schema_name, text_property.table_name, text_property.notes, text_property.fk_creator, text_property.fk_last_modifier, text_property.tmsp_creation, text_property.tmsp_last_modification, text_property.sys_period, text_property._deprecated_text_property, text_property.fk_concerned_entity, text_property._deprecated_text_property_quill_doc, text_property.fk_language, text_property.fk_class_field;
