...
------------------------------------------------------------------------------------------------------------
-- 1. REWORK TABLE information.entity_association (including *_vt)
------------------------------------------------------------------------------------------------------------

  ALTER TABLE information.entity_association RENAME COLUMN fk_range_entity TO fk_info_range;
  ALTER TABLE information.entity_association RENAME COLUMN fk_domain_entity TO fk_info_domain;
  ALTER TABLE information.entity_association ADD COLUMN fk_data_domain integer; 
  -- REFERENCES data.entity (pk_entity), -- Not possible to reference parent
  ALTER TABLE information.entity_association ADD COLUMN fk_data_range integer; 
  -- REFERENCES data.entity (pk_entity), -- Not possible to reference parent

------------------------------------------------------------------------------------------------------------
-- 2. DROP VIEWS depending on v_entity_association
------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------
-- 3. RECREATE VIEW v_entity_association
------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------
-- 4. RECREATE VIEW v_entity_association_per_project_and_repo
------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------
-- 6. RECREATE VIEW v_entity_preview_non_recursive
------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------
-- 7. RECREATE VIEW v_entity_preview
------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------
-- 8. RECREATE VIEW v_entity_association
------------------------------------------------------------------------------------------------------------
