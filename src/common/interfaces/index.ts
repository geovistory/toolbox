...
export * from './table-query-res.interface';
export * from './time-chart-cont-input.interface';
export * from './time-chart-cont-output.interface';
export * from './time-chart-cont-query-res.interface';
// end:ng42.barrel
