...
import { GvSubentitFieldPageReq, GvFieldTargetViewType, SysConfigFormCtrlType } from '@kleiolab/lib-sdk-lb4';
import { SpecialFieldType } from '../../queries/configuration/models/SpecialFieldType';
import { Field, FieldBase, FieldTargetClass } from '../../queries/public-api';
import { DfhApiClassMock } from './auto-gen/gvDB/DfhApiClassMock';
import { DfhApiPropertyMock } from './auto-gen/gvDB/DfhApiPropertyMock';
import { DfhApiClass, NewDfhApiProperty } from './auto-gen/gvDB/local-model.helpers';
...
export const FieldMock = {
  presenceWasAtPlace,
  manifestationSingletonHasDefinition,
  manifestationSingletonHasShortTitle,
  accountOfJourneyHasDuration,
  componentHasVolume,
  appeHasAppeString,
