...
/**
 * (tsType: InfTimePrimitiveWithRelations, schemaOptions: { includeRelations: true })
 */
export interface InfTimePrimitiveWithRelations { 
    pk_entity?: number;
    fk_class: number;
    julian_day: number;
    duration: InfTimePrimitiveWithRelations.DurationEnum;
    calendar: InfTimePrimitiveWithRelations.CalendarEnum;
}
export namespace InfTimePrimitiveWithRelations {
