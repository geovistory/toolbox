...
export function latestVersion<T extends { entity_version: number }>(versions: ByPk<T>): T {
  let latestVersion = 0
  let latest;
...
export function getSpecificVersion<T extends { entity_version: number }>(versions: ByPk<T>, version): T {
