...
export default sandboxOf(TeEntPropertyFieldFormComponent, {
    ...
    .add('TeEnt PropertyField Form | Birth (with child)', {
        context: {
            addForm: {},
            createForm: {},
            cancelled: undefined,
            added: undefined,
            parentPath: ['_teEnt', '_fields', '_6_outgoing'],
            ...
            initState: {
                ...
                "_teEnt": {
                    ...
                    "_fields": {
                        "_6_outgoing": {
                            _property_field_form: {}, // <- add this to init the role set (gv-te-ent-property-field-form)
                            "isOutgoing": true,
                            "property": {
                                "dfh_pk_property": 6,
        ...
        <div class="d-flex justify-content-center mt-5">
            <div style="width:430px;height:400px" class="d-flex">
                ...
                <gv-te-ent-property-field-form [parentPath]="parentPath" [parentTeEntPath]="parentTeEntStatePath" (createRoles)="createRoles($event)" (addFormChange)="addForm = $event" 
                (createFormChange)="createForm = $event" ></gv-te-ent-property-field-form>
    ...
    .add('TeEnt PropertyField Form | Birth (no child)', {
        context: {
            addForm: {},
            createForm: {},
            cancelled: undefined,
    ...
    .add('TeEnt PropertyField Form | Appellation', {
        context: {
            addForm: {},
            createForm: {},
            cancelled: undefined,
            added: undefined,
            parentPath: ['_teEnt', '_fields', '_2_outgoing'],
            parentTeEntStatePath: ['_teEnt'],
            initState: {
                "activeProject": {
                    "pk_project": 51
