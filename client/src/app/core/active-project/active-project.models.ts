...
export interface Tab {
  ...
  component: 'text-detail' | 'pe-it-detail' | 'te-en-detail' | 'query-detail' | 'visual-detail' | 'classes-settings' | 'contr-vocab-settings';
  // icon to be displayed in tab, e.g.: gv-icon-source
  icon: 'text' | 'persistent-entity' | 'temporal-entity' | 'source' | 'expression-portion' | 'query' | 'visual' | 'story' | 'settings';
  // name of the pathSegment under 'activeProject', used to generate the path: ['activeProject', pathSegment, uiId]
  pathSegment: 'textDetails' | 'peItDetails' | 'teEnDetails' | 'queryDetails' | 'visualDetails' | 'classesSettings' | 'contrVocabSettings';
