...
export interface Tab<D> {
  ...
  component: 'text-detail' | 'pe-it-detail' | 'te-en-detail' | 'analysis-detail' | 'query-detail' | 'visual-detail' | 'classes-settings' | 'contr-vocab-settings';
  ...
  pathSegment: 'textDetails' | 'peItDetails' | 'teEnDetails' | 'analysisDetails' | 'queryDetails' | 'visualDetails' | 'classesSettings' | 'contrVocabSettings';
