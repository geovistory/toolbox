...
import { InfPersistentItem, InfStatement, InfTemporalEntity, InfAppellation, InfPlace, InfTimePrimitive, InfTextProperty, InfLanguage, DatDigital, InfLangString, InfDimension } from 'app/core/sdk';
