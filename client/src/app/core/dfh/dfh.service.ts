...
import { DfhClassSlice, DfhPropertyProfileViewSlice, DfhLabelSlice, DfhPropertyViewSlice, DfhClassProfileViewSlice } from './dfh.models';
...
// ClassProfileView Selectors
class DfhClassProfileViewSelections extends Selector<DfhClassProfileViewSlice> {
  public by_pk_entity$ = this.selector<DfhClassProfileView>('by_pk_entity');
  public by_dfh_pk_class$ = this.selector<ByPk<DfhClassProfileView>>('by_dfh_pk_class');
  public loading$ = this.selector<boolean>('loading');
}
...
class DfhPropertyViewSelections extends Selector<DfhPropertyViewSlice> {
  public by_pk_entity$ = this.selector<DfhPropertyView>('by_pk_entity');

  public by_fk_property$ = this.selector<ByPk<DfhPropertyView>>('by_fk_property');
  public by_dfh_has_domain__fk_property__dfh_has_range$ = this.selector<ByPk<DfhPropertyView>>('by_dfh_has_domain__fk_property__dfh_has_range');
...
export class DfhSelector extends DfhActions {
  ...
  class_profile_view$ = new DfhClassProfileViewSelections(this.ngRedux, dfhDefinitions, 'class_profile_view', this.pause.shouldPause$)
