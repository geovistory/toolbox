...
export class InfEntityProjectRelApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id InfEntityProjectRel id
   *
   * @param {object} data Request data.
   *
   ...
   * </em>
   */
  public updateEprAttributes(projectId: any, pkEntity: any, eprAttributes: any, customHeaders?: Function): Observable<any> {
