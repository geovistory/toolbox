...
export class U {
  ...
  */
  ...
  /**
   * Creates a tree from a flat list, see:
   * http://jsfiddle.net/alexandrupausan/qjxpLhfu/
   */
  static unflatten(arr, idProp: string, parentIdProp: string) {
    var tree = [],
      mappedArr = {},
      arrElem,
      mappedElem;
    ...
    for (var id in mappedArr) {
      if (mappedArr.hasOwnProperty(id)) {
        ...
        if (mappedElem[parentIdProp]) {
          mappedArr[mappedElem[parentIdProp]]['children'].push(mappedElem);
        }
