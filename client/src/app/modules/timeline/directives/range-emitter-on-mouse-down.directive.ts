...
export class RangeEmitterOnMouseDownDirective implements OnInit {
  ...
  @Input() rangeEmitterOnMouseDown: ElementRef;
  ...
  ngOnInit() {
    this.d3Service.applyRangeEmitterOnKeyDown(this._element.nativeElement, this.rangeEmitterOnMouseDown.nativeElement)
      .subscribe((event) => {
