...
export const propertyFieldReducer =
  (lastState: PropertyField = INITIAL_STATE, action: PropertyFieldAction): PropertyField => {
    ...
    switch (action.type) {
      ...
      // case PropertyFieldActions.ROLE_SET_REMOVED:
      //   lastState = undefined
      //   break;
      ...
      case PropertyFieldActions.ALTERNATIVE_ROLES_LOADED:
        lastState = {
          ...
          _property_field_form: {
            ...lastState._property_field_form,
            _role_add_list: action.payload._property_field_form._role_add_list,
            _role_add_in_no_project_list: action.payload._property_field_form._role_add_in_no_project_list
          }
        }
        break;
      ...
      case PropertyFieldActions.START_CREATE_NEW_ROLE:
        lastState = {
          ...
          rolesNotInProjectLoading: false,
          _property_field_form: {
            ...omit(['_role_add_list'], lastState._property_field_form),
            _role_create_list: Object.assign({},
              lastState._property_field_form._role_create_list,
              action.payload._property_field_form._role_create_list)
          }
        }
        break;
      ...
      case PropertyFieldActions.STOP_CREATE_NEW_ROLE:
        lastState = {
          ...new PropertyField(omit(['_property_field_form'], lastState)),
      ...
      case PropertyFieldActions.ROLE_CREATION_CANCELLED:
        lastState = {
          ...
          _property_field_form: {
            ...lastState._property_field_form,
            _role_create_list: action.payload._property_field_form._role_create_list
          }
        }
        break;
