...
export default sandboxOf(TeEntPropertyFieldAddCtrlComponent, {
    imports: [
        InitStateModule,
        Information2Module
    ],
        ...
        template: `
            ...
            <div class="d-flex justify-content-center mt-5">
                <div style="width:430px;height:400px" class="d-flex">
                    <form #f="ngForm">
                        <gv-te-ent-property-field-add-ctrl [parentPath]="parentPath" [index]="index"
                            name="roles" [(ngModel)]="model.roles" #roles="ngModel" required>
                        </gv-te-ent-property-field-add-ctrl>
                    </form>                               
                </div>
                <div>
