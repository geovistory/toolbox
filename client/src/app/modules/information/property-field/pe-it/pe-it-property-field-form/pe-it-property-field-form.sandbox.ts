...
import { PeItPropertyFieldFormComponent } from './pe-it-property-field-form.component';
...
export default sandboxOf(PeItPropertyFieldFormComponent, {
    ...
    .add('PeIt PropertyField Form | Appellation ', {
        context: {
            addForm: {},
            createForm: {},
            cancelled: undefined,
            added: undefined,
            parentPath: ['_peIt_editable', '_fields', '_1_ingoing'],
            ...
            initState: {
                ...
                "_peIt_editable": {
                    ...
                    "_fields": {
                        "_1_ingoing": {
                            _property_field_form: {}, // <- add this to init the role set (gv-pe-it-property-field-form)
                            "isOutgoing": false,
                            "property": {
                                "dfh_pk_property": 1,
        ...
        template: `
            ...
            <div class="d-flex justify-content-center mt-5">
                <div style="width:430px;height:400px" class="d-flex bg-secondary">
                    ...
                    <gv-pe-it-property-field-form [parentPath]="parentPath" [parentPeItPath]="parentPeItStatePath" (createRoles)="createRoles($event)" (addFormChange)="addForm = $event" 
                    (createFormChange)="createForm = $event" ></gv-pe-it-property-field-form>
