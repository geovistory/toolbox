...
export class TextPropertyFieldAPIEpics {
  ...
  public createEpics(c: TextPropertyFieldComponent): Epic {
    return combineEpics(this.createLoadTextPropertyFieldEpic(c));
  }

  private createLoadTextPropertyFieldEpic(c: TextPropertyFieldComponent): Epic {
    return (action$, store) => {
      return action$.pipe(
        /**
         * Filter the actions that triggers this epic
         */
        ofType(TextPropertyFieldAPIActions.LOAD),
