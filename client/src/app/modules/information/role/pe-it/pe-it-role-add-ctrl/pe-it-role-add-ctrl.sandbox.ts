...
export default sandboxOf(PeItRoleAddCtrlComponent, {
  imports: [
    InitStateModule,
    Information2Module
  ],
    ...
    template: `
            ...
            <div class="d-flex justify-content-center mt-5">
                <div style="width:430px;height:400px" class="d-flex">
                    <form #f="ngForm">
                        <gv-pe-it-role-add-ctrl [parentPath]="parentPath" [intermediatePathSegment]="intermediatePathSegment" [index]="index"
                            name="role" [(ngModel)]="model.role" #role="ngModel" required>
                        </gv-pe-it-role-add-ctrl>
                    </form>                               
                </div>
                <div>
