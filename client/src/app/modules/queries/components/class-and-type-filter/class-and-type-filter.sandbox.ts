...
export default sandboxOf(ClassAndTypeFilterComponent, {
        ...
        <div class="d-flex justify-content-center mt-5">
            <div style="width:430px;height:400px" class="d-flex mr-4">
                <form #f="ngForm" class="gv-grow-1">
                    <mat-form-field>
                        <gv-class-and-type-filter placeholder="Enter Foo" name="control" [(ngModel)]="model" #control="ngModel" [pkClasses$]="pkClasses$" gvClassAndTypeFilterRequired></gv-class-and-type-filter>
    ...
    .add('Class and type Filter | Preset ', {
        ...
        <div class="d-flex justify-content-center mt-5">
            <div style="width:430px;height:400px" class="d-flex mr-4">
                <form #f="ngForm" class="gv-grow-1">
                        <gv-class-and-type-filter name="control" [(ngModel)]="model" #control="ngModel" [pkClasses$]="pkClasses$" gvClassOrTypeRequired></gv-class-and-type-filter>               
                </form>
            </div>
            <div>
                <p>Form.valid: {{f.valid | json}}</p>
