...
export class InfEntityAssociation {
    ...
    entity_version_project_rels: InfEntityVersionProjectRel[];
    chunk: InfChunk;
}

export interface InfChunk {
    js_quill_data: object;
 ...
 * For each entity in entities add a MentionedEntityViewComponent passing in the mE and show a button with (click)="remove()""
 */
export class MentionedEntitiesCtrlComponent implements ControlValueAccessor {
 ...
 */
export class AnnotationCtrlComponent implements ControlValueAccessor {
