...
/**
 * @module GvInternalStorage
 * @author Jonas Schneider
 * @description
 * The GvInternalStorage class is used for dependency injection swapping.
 * It will be provided using factory method from different sources.
 * This is mainly required because Angular Universal integration.
 * It does inject a CookieStorage instead of LocalStorage.
 **/
export class GvInternalStorage extends GvBaseStorage { }
/**
 * @module GVStorage
 * @author Jonas Schneider
 * @description
 * The GVStorage class is used for dependency injection swapping.
 ...
 **/
export class GVStorage extends GvBaseStorage { }
