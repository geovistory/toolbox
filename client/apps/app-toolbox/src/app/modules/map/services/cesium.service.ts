...
import { BaseLayerPicker, Color, Credit, CustomDataSource, Entity, NavigationHelpButton, OpenStreetMapImageryProvider, PointGraphics, PointPrimitive, ProviderViewModel, SceneMode, SceneModePicker, ScreenSpaceEventHandler, ScreenSpaceEventType, UrlTemplateImageryProvider, Viewer, WebMercatorProjection, buildModuleUrl, defined } from 'cesium';
...
export class CesiumService {
  ...
  addMouseoverHighlight() {
    ...
    const handler = new ScreenSpaceEventHandler(this.viewer.scene.canvas as HTMLCanvasElement);
