...
@Component({
    ...
    standalone: true,
    imports: [NgIf, ViewTimeSpanSectionHeaderComponent, MatDividerModule, ViewTimeSpanSectionBodyComponent, ViewTimeSpanItemComponent, ViewSectionBodyComponent, AsyncPipe]
})
