...
@Component({
  selector: 'gv-visualization-map-with-time',
  templateUrl: './visualization-map-with-time.component.html',
  styleUrls: ['./visualization-map-with-time.component.scss'],
  standalone: true,
...
export class VisualizationMapWithTimeComponent implements OnInit {
