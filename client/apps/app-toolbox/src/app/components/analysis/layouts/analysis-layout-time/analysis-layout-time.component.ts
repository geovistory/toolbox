...
@Component({
  selector: 'gv-analysis-layout-time',
  templateUrl: './analysis-layout-time.component.html',
  styleUrls: ['./analysis-layout-time.component.scss'],
  standalone: true,
  imports: [
...
export class AnalysisLayoutTimeComponent implements OnInit, OnDestroy {
