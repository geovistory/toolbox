...
describe('ConfigurationPipeService', () => {
  ...
  describe('.pipeProfilesEnabledByProject()', () => {
    it('should return two custom profiles + basic profile (id:5)', async () => {
      ...
      storeSchemaObjectGv(gvSchemaObj, PK_DEFAULT_CONFIG_PROJECT)
  ...
  describe('.pipeNestedResource()', () => {
    it('should go through nested fields of stems from - union', async () => {
      ...
      storeSchemaObjectGv(GvSchemaObjectMock.project1, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.sysConfig, PK_DEFAULT_CONFIG_PROJECT)
  ...
  describe('.pipeFieldLabel()', () => {
    it('should return label for EN_1111_IS_APPE_OF', (done) => {
      facade.setState(IAppStateMock.stateProject1)
      storeSchemaObjectGv(GvSchemaObjectMock.project1, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.basicClassesAndProperties, PK_DEFAULT_CONFIG_PROJECT)
  ...
  describe('.pipeTargetTypesOfClass()', () => {
    ...
    it('should return typeItem/typeItem for EN_364_GEO_PLACE_TYPE', (done) => {
      facade.setState(IAppStateMock.stateProject1)
      storeSchemaObjectGv(GvSchemaObjectMock.sysConfig, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.classGeographicalPlaceType, PK_DEFAULT_CONFIG_PROJECT)
    ...
    it('should return entityPreview/entity for EN_363_GEO_PLACE', (done) => {
      facade.setState(IAppStateMock.stateProject1)
      storeSchemaObjectGv(GvSchemaObjectMock.sysConfig, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.classGeographicalPlace, PK_DEFAULT_CONFIG_PROJECT)
    ...
    it('should return entity/nestedRessource for EN_61_BIRTH', (done) => {
      ...
      storeSchemaObjectGv(GvSchemaObjectMock.project1, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.basicClassesAndProperties, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.modelOfBirth, PK_DEFAULT_CONFIG_PROJECT)
  ...
  describe('.pipeFields()', () => {
    ...
    it('should return correct fields of manifestation singleton', (done) => {
      facade.setState(IAppStateMock.stateProject1)
      storeSchemaObjectGv(GvSchemaObjectMock.basicClassesAndProperties, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.fieldsOfManifestationSingleton, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.project1, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.sysConfig, PK_DEFAULT_CONFIG_PROJECT)
    ...
    it('should return fields of presence', (done) => {
      facade.setState(IAppStateMock.stateProject1)
      storeSchemaObjectGv(GvSchemaObjectMock.basicClassesAndProperties, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.modelOfPresence, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.project1, PK_DEFAULT_CONFIG_PROJECT)
      storeSchemaObjectGv(GvSchemaObjectMock.sysConfig, PK_DEFAULT_CONFIG_PROJECT)
