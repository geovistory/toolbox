...
import { limitTo, sortAbc, switchMapOr } from 'projects/toolbox/src/app/core';
...
import { InfTextProperty } from "projects/toolbox/src/app/core/sdk";
import { InfStatement } from "projects/toolbox/src/app/core/sdk";
import { TimeSpan } from "projects/toolbox/src/app/core/time-span/time-span";
import { U } from "projects/toolbox/src/app/core/util/util";
import { Granularity } from 'projects/toolbox/src/app/core/date-time/date-time-commons';
import { CalendarType } from 'projects/toolbox/src/app/core/date-time/time-primitive';
import { InfModelName } from 'projects/toolbox/src/app/core/inf/inf.config';
import { InfSelector } from 'projects/toolbox/src/app/core/inf/inf.service';
import { DfhConfig } from 'projects/toolbox/src/app/modules/information/shared/dfh-config';
...
import { PropertyOption, PropertySelectModel } from 'projects/toolbox/src/app/modules/queries/components/property-select/property-select.component';
import { cache, spyTag } from 'projects/toolbox/src/app/shared';
import { TimePrimitivePipe } from 'projects/toolbox/src/app/shared/pipes/time-primitive/time-primitive.pipe';
import { TimeSpanPipe } from 'projects/toolbox/src/app/shared/pipes/time-span/time-span.pipe';
...
import { PaginateByParam } from 'projects/toolbox/src/app/core/redux-store/actions';
 ...
 */
  ...
  @spyTag pipeItemDimension(statement: InfStatement): Observable<DimensionItem> {
    return this.p.inf$.dimension$.by_pk_entity$.key(statement.fk_object_info).pipe(
      filter(x => !!x),
      switchMap((dimension) => {
