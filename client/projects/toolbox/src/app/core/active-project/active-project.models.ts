import { DatChunk, InfPersistentItem, InfTemporalEntity, ProDfhClassProjRel, SysAppContextInterface, SysClassFieldInterface } from 'projects/toolbox/src/app/core/sdk';
import { EntityDetail } from 'projects/toolbox/src/app/core/state/models';
// import { CreateOrAddEntity } from 'projects/toolbox/src/app/modules/information/containers/create-or-add-entity/create-or-add-entity.component';
import { ProjectSettingsData } from 'projects/toolbox/src/app/modules/projects/containers/project-settings-data/api/project-settings-data.models';
// import { VisualDetail } from 'projects/toolbox/src/app/modules/visuals/containers/visual-detail/api/visual-detail.models';
