...
import { FilterDefinition, QueryFilterComponent } from 'projects/toolbox/src/app/modules/queries/components/query-filter/query-filter.component';
import { QueryPathFormComponent } from 'projects/toolbox/src/app/modules/queries/forms/query-path/query-path-form/query-path-form.component';
import { values } from 'd3';
import { BehaviorSubject, Observable, Subject, of } from 'rxjs';
import { map } from 'rxjs/operators';
import { TableFormNodeConfig } from './table-form.component';
import { ColDef } from 'projects/toolbox/src/app/core/sdk-lb4/model/colDef';
import { QueryFilter, AnalysisDefinition, QueryPathSegment } from 'projects/toolbox/src/app/core/sdk-lb4/model/models';
