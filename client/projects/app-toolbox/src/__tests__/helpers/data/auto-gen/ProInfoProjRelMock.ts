...
import { ProInfoProjRel } from 'projects/app-toolbox/src/app/core/sdk-lb4';
...
export class ProInfoProjRelMock {
  static readonly PROJ_1_PERSON_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2001,
  ...
  static readonly PROJ_1_NAMING_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2002,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_NAME_1_TO_APPE: Partial<ProInfoProjRel> = ({
    pk_entity: 2003,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_NAME_1_TO_PERSON: Partial<ProInfoProjRel> = ({
    pk_entity: 2004,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_MADRID: Partial<ProInfoProjRel> = ({
    pk_entity: 2005,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_CITY_TYPE: Partial<ProInfoProjRel> = ({
    pk_entity: 2006,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_NAMING_CITY: Partial<ProInfoProjRel> = ({
    pk_entity: 2007,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_MADRID_HAS_GEO_PLACE_CITY_TYPE: Partial<ProInfoProjRel> = ({
    pk_entity: 2008,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_NAMING_CITY_TO_APPE_CITY: Partial<ProInfoProjRel> = ({
    pk_entity: 2009,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_NAMING_CITY_TO_GEO_PLACE_TYPE: Partial<ProInfoProjRel> = ({
    pk_entity: 2010,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_SHIP_VOYAGE: Partial<ProInfoProjRel> = ({
    pk_entity: 2011,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_SHIP_VOYAGE_ONGOING_THROUGHOUT_TP_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2012,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_SHIP_VOYAGE_AT_SOME_TIME_WITHIN_TP_2: Partial<ProInfoProjRel> = ({
    pk_entity: 2013,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_SHIP_VOYAGE_END_OF_THE_BEGIN_TP_3: Partial<ProInfoProjRel> = ({
    pk_entity: 2014,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_SHIP_VOYAGE_BEGIN_OF_THE_END_TP_4: Partial<ProInfoProjRel> = ({
    pk_entity: 2015,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_SHIP_VOYAGE_BEGIN_OF_THE_BEGIN_TP_5: Partial<ProInfoProjRel> = ({
    pk_entity: 2016,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_SHIP_VOYAGE_END_OF_THE_END_TP_6: Partial<ProInfoProjRel> = ({
    pk_entity: 2017,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_BIRTH_1_BROUGHT_INTO_LIFE_PERON_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2018,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_BIRTH_1_STEMS_FROM_UNION_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2019,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_BIRTH: Partial<ProInfoProjRel> = ({
    pk_entity: 2020,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_UNION_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2021,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_STMT_UNOIN_1_HAS_PARTNER_1: Partial<ProInfoProjRel> = ({
    pk_entity: 2022,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly SANDBOX_ALBERT_IV: Partial<ProInfoProjRel> = ({
    pk_entity: 2023,
  ...
  static readonly SANDBOX_ALBERT_IV_NAMING: Partial<ProInfoProjRel> = ({
    pk_entity: 2024,
    fk_project: ProProjectMock.SANDBOX_PROJECT.pk_entity,
  ...
  static readonly SANDBOX_RUDOLF: Partial<ProInfoProjRel> = ({
    pk_entity: 2025,
    fk_project: ProProjectMock.SANDBOX_PROJECT.pk_entity,
  ...
  static readonly SANDBOX_RUDOLF_NAMING: Partial<ProInfoProjRel> = ({
    pk_entity: 2026,
    fk_project: ProProjectMock.SANDBOX_PROJECT.pk_entity,
  ...
  static readonly PROJ_1_STMT_UNOIN_1_HAS_PARTNER_2: Partial<ProInfoProjRel> = ({
    pk_entity: 2027,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
  ...
  static readonly PROJ_1_ALBERT_IV: Partial<ProInfoProjRel> = ({
    pk_entity: 2028,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
    fk_entity: InfPersistentItemMock.ALBERT_IV.pk_entity,
    fk_last_modifier: PubAccountMock.GAETAN_VERIFIED.id,
