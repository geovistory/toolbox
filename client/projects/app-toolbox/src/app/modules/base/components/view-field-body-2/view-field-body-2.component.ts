...
import { GvFieldPageScope, GvFieldSourceEntity, StatementWithTarget } from '@kleiolab/lib-sdk-lb4';
import { BehaviorSubject, Observable, Subject } from 'rxjs';
import { openClose } from '../../../information/shared/animations';
import { temporalEntityListDefaultLimit, temporalEntityListDefaultPageIndex } from '../../base.helpers';
...
@Component({
  selector: 'gv-view-field-body-2',
  templateUrl: './view-field-body-2.component.html',
  styleUrls: ['./view-field-body-2.component.scss'],
...
export class ViewFieldBody2Component implements OnInit, OnDestroy {
