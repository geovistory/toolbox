 ...
 */
export function transformDfhApiClassToDfhClass(dfhApiClass) {
    return {
 ...
 */
export function transformDfhApiPropertyToDfhProperty(dfhApiProperty) {
    return {
...
*/
export function transformDfhApiClassToDfhLabel(dfhApiClass) {
    return {
...
* to a DfhLabel (redux store format)
*/
export function transformDfhApiPropertyToDfhLabel(dfhApiProperty) {
    return {
