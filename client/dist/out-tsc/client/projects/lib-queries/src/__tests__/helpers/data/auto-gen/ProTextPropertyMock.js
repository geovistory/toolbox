...
ProTextPropertyMock.PROJ_DEF_DE_PROPERTY_BROUGHT_INTO_LIFE = ({
    pk_entity: 5001,
...
ProTextPropertyMock.PROJ_DEF_DE_PROPERTY_BROUGHT_INTO_LIFE_REVERSE = ({
    pk_entity: 5002,
    fk_project: PK_DEFAULT_CONFIG_PROJECT,
    fk_language: InfLanguageMock.GERMAN.pk_entity,
    fk_dfh_property: DfhApiPropertyMock.EN_86_BROUGHT_INTO_LIFE.dfh_pk_property,
...
ProTextPropertyMock.PROJ_1_PROPERTY_BROUGHT_INTO_LIFE = ({
    pk_entity: 5003,
...
ProTextPropertyMock.PROJ_1_PROPERTY_BROUGHT_INTO_LIFE_REVERSE = ({
    pk_entity: 5004,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
    fk_language: InfLanguageMock.GERMAN.pk_entity,
    fk_dfh_property: DfhApiPropertyMock.EN_86_BROUGHT_INTO_LIFE.dfh_pk_property,
...
ProTextPropertyMock.PROJ_1_PROPERTY_PERSON_HAS_APPELLATION = ({
    pk_entity: 5005,
    fk_project: ProProjectMock.PROJECT_1.pk_entity,
    fk_language: InfLanguageMock.GERMAN.pk_entity,
...
ProTextPropertyMock.PROJ_DEF_EN_PROPERTY_BROUGHT_INTO_LIFE = ({
    pk_entity: 5006,
    fk_project: PK_DEFAULT_CONFIG_PROJECT,
...
ProTextPropertyMock.PROJ_DEF_EN_PROPERTY_BROUGHT_INTO_LIFE_REVERSE = ({
    pk_entity: 5007,
    fk_project: PK_DEFAULT_CONFIG_PROJECT,
    fk_language: InfLanguageMock.ENGLISH.pk_entity,
    fk_dfh_property: DfhApiPropertyMock.EN_86_BROUGHT_INTO_LIFE.dfh_pk_property,
...
ProTextPropertyMock.PROJ_DEF_EN_PROPERTY_PERSON_HAS_APPELLATION = ({
    pk_entity: 5008,
    fk_project: PK_DEFAULT_CONFIG_PROJECT,
    fk_language: InfLanguageMock.ENGLISH.pk_entity,
    fk_dfh_property: DfhApiPropertyMock.EN_1111_IS_APPE_OF.dfh_pk_property,
...
ProTextPropertyMock.SANDBOX_PROJECT_NAME = ({
    pk_entity: 5009,
...
//# sourceMappingURL=ProTextPropertyMock.js.map