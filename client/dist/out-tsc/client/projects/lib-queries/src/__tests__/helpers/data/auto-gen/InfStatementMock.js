...
InfStatementMock.SHIP_VOYAGE_ONGOING_THROUGHOUT_TP_1 = ({
    pk_entity: 3006,
...
InfStatementMock.SHIP_VOYAGE_END_OF_THE_BEGIN_TP_3 = ({
    pk_entity: 3008,
    fk_subject_info: InfTemporalEntityMock.SHIP_VOYAGE.pk_entity,
...
InfStatementMock.NAMING_HABS_EMP_TO_PEIT_HABS_EMP = ({
    pk_entity: 3023,
...
InfStatementMock.NAMING_HABS_EMP_TO_APPE_HABS_EMP = ({
    pk_entity: 3024,
    fk_subject_info: InfTemporalEntityMock.HABSBOURG_EMPIRE_NAMING.pk_entity,
    fk_property: DfhApiPropertyMock.EN_1113_REFERS_TO_NAME.dfh_pk_property,
    fk_object_info: InfAppellationMock.SOURCE_HABSBOURG_EMPIRE.pk_entity,
});
InfStatementMock.DIGITAL_BIRTHDATES_IS_REPRODUCTION_OF_HABS_EMP = ({
    pk_entity: 3025,
...
InfStatementMock.DIGITAL_RANDOM_IS_REPRODUCTION_OF_HABS_EMP = ({
    pk_entity: 3027,
...
//# sourceMappingURL=InfStatementMock.js.map