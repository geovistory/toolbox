...
let DfhProfileService = class DfhProfileService {
    ...
    dfhProfileDeactivateProfileForProject(pkProject, pkProfile, observe = 'body', reportProgress = false, options) {
        ...
        if (pkProfile !== undefined && pkProfile !== null) {
            queryParameters = this.addToHttpParams(queryParameters, pkProfile, 'pkProfile');
        }
    ...
    dfhProfileGetActivationReport(pkProject, pkProfile, requestedLanguage, observe = 'body', reportProgress = false, options) {
        ...
        if (requestedLanguage !== undefined && requestedLanguage !== null) {
            queryParameters = this.addToHttpParams(queryParameters, requestedLanguage, 'requestedLanguage');
        }
        let headers = this.defaultHeaders;
        let credential;
        // authentication (accesstoken) required
...
DfhProfileService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=dfhProfile.service.js.map