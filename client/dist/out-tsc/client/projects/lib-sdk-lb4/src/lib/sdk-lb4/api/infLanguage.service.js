...
let InfLanguageService = class InfLanguageService {
    ...
    infLanguageQueryByString(queryString, observe = 'body', reportProgress = false, options) {
        ...
        if (queryString !== undefined && queryString !== null) {
            queryParameters = this.addToHttpParams(queryParameters, queryString, 'queryString');
        }
        let headers = this.defaultHeaders;
        let credential;
        // authentication (accesstoken) required
...
InfLanguageService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=infLanguage.service.js.map