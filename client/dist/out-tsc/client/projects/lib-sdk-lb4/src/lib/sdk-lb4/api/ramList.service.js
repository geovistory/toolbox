...
let RamListService = class RamListService {
    ...
    ramListControllerGetRamList(pkProject, pkEntity, fkProperty, refersTo, observe = 'body', reportProgress = false, options) {
        ...
        if (fkProperty !== undefined && fkProperty !== null) {
            queryParameters = this.addToHttpParams(queryParameters, fkProperty, 'fkProperty');
        }
        if (refersTo !== undefined && refersTo !== null) {
            queryParameters = this.addToHttpParams(queryParameters, refersTo, 'refersTo');
        }
...
RamListService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=ramList.service.js.map