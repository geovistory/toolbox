...
let PubAccountService = class PubAccountService {
    ...
    pubAccountLogin(body, include, observe = 'body', reportProgress = false, options) {
        ...
        if (include !== undefined && include !== null) {
            queryParameters = this.addToHttpParams(queryParameters, include, 'include');
        }
        let headers = this.defaultHeaders;
        let credential;
        // authentication (accesstoken) required
...
PubAccountService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=pubAccount.service.js.map