...
let DatColumnService = class DatColumnService {
    ...
    datColumnOfDigital(pkProject, pkDigital, observe = 'body', reportProgress = false, options) {
        ...
        if (pkDigital !== undefined && pkDigital !== null) {
            queryParameters = this.addToHttpParams(queryParameters, pkDigital, 'pkDigital');
        }
...
DatColumnService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=datColumn.service.js.map