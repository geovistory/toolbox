...
let ContentTreeService = class ContentTreeService {
    ...
    contentTreeControllerGetContentTree(pkProject, pkExpressionEntity, observe = 'body', reportProgress = false, options) {
        ...
        if (pkExpressionEntity !== undefined && pkExpressionEntity !== null) {
            queryParameters = this.addToHttpParams(queryParameters, pkExpressionEntity, 'pkExpressionEntity');
        }
...
ContentTreeService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=contentTree.service.js.map