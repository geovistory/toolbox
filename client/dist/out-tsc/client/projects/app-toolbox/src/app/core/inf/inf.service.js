import { getFromTo, paginatedBy, paginateKey, paginateName, PR_ENTITY_MODEL_MAP } from 'projects/app-toolbox/src/app/core/redux-store/reducer-factory';
import { pipe, of } from 'rxjs';
import { filter, first, map, switchMap } from 'rxjs/operators';
import { combineLatestOrEmpty } from '../util/combineLatestOrEmpty';
import { infDefinitions, infRoot, indexStatementBySubjectProperty, indexStatementByObjectProperty, indexStatementBySubject, indexStatementByObject } from './inf.config';
