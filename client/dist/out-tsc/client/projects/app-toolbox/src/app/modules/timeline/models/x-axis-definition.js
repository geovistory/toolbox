...
export class XAxisDefinition {
    constructor(options, datePipe) {
        ...
        this.minJulianSecond = Number.NEGATIVE_INFINITY;
        this.maxJulianSecond = Number.POSITIVE_INFINITY;
    ...
    setScale() {
         ...
         */
        const addTickIfValid = (ticks, julianSecond) => {
    ...
    getDateFormatString(julianDay, granularity) {
...
//# sourceMappingURL=x-axis-definition.js.map