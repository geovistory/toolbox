 ...
 * @param subfieldType
 */
export function isValueObjectSubfield(subfieldType) {
 ...
 * @param subfieldType
 */
export function isLeafItemSubfield(subfieldType) {
    if (isValueObjectSubfield(subfieldType))
        return true;
    else if (subfieldType.entityPreview)
        return true;
    return false;
}
export function createPaginateBy(listDefinition, pkEntity, alternatives = false) {
