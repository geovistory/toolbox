...
import { QueriesModule } from 'projects/app-toolbox/src/app/modules/queries/queries.module';
...
const initVal3 = [{ type: 'classes', data: { classes: [442], types: [] } }, { data: { ingoingProperties: [], outgoingProperties: [1189] }, type: 'properties' }, { data: { types: [81893], classes: [68] }, type: 'classes' }, { data: { ingoingProperties: [1182], outgoingProperties: [] }, type: 'properties' }, { data: { types: [], classes: [212] }, type: 'classes' }, { data: { ingoingProperties: [], outgoingProperties: [1178] }, type: 'properties' }, { data: { types: [80412], classes: [363] }, type: 'classes' }];
const initVal4 = [{ type: 'classes', data: { classes: [442], types: [] } }, { data: { ingoingProperties: [], outgoingProperties: [1189] }, type: 'properties' }, { data: { types: [81893], classes: [68] }, type: 'classes' }];
...
//# sourceMappingURL=query-path-form.sandbox.js.map