...
const data1$ = new BehaviorSubject({
    activeLine: null,
    chartLines: [
        {
            label: 'Sample 1',
...
const hugeLine = JSON.parse(ship_voyages);
const data2$ = new BehaviorSubject({
    activeLine: 0,
    chartLines: [
        {
            label: 'Ship Voyages',
...
const shipVoyagesByPlace = JSON.parse(ship_voyages_by_place);
const data3$ = new BehaviorSubject({
    activeLine: null,
    chartLines: shipVoyagesByPlace
});
const births = JSON.parse(births_40k);
const data4$ = new BehaviorSubject({
    activeLine: 0,
    chartLines: [
        {
            label: 'Births',
...
const data5$ = new BehaviorSubject({
    activeLine: 0,
    chartLines: [
        {
            label: 'Births',
...
export default sandboxOf(TimelineChartComponent, {
    ...
    context: {
        data1$,
        showCursor$: new BehaviorSubject(true)
    },
    template: `
...
//# sourceMappingURL=timeline-chart.sandbox.js.map