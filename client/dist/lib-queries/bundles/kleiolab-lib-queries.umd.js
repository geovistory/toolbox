(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@kleiolab/lib-queries', ['exports', 'rxjs/operators', 'rxjs-spy/operators', '@kleiolab/lib-config', '@kleiolab/lib-utils', '@angular/common', '@angular/core', '@kleiolab/lib-redux', '@angular-redux/store', 'rxjs', 'd3', 'ramda', '@kleiolab/lib-sockets', '@kleiolab/lib-sdk-lb3'], factory) :
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-queries'] = {}), global.rxjs.operators, global.operators$1, global.libConfig, global.libUtils, global.ng.common, global.ng.core, global.libRedux, global.store, global.rxjs, global.d3, global.ramda, global.libSockets, global.libSdkLb3));
    ...
    ***************************************************************************** */
    ...
    var Selector$2 = /** @class */ (function () {
        ...
        function (indexKey) {
             ...
             */
            function (x) {
                return _this.ngRedux.select([libRedux.infRoot, _this.model, indexKey, x]);
            });
            return { all$: all$, key: key };
        };
        /**
    ...
    var ConfigurationPipesService = /** @class */ (function () {
        ...
        */
        ...
        function (isOutgoing, p, sysConfig, enabledProfiles) {
            ...
            function (x) {
                return x;
            }))), this.pipeSubfieldTypeOfClass(sysConfig, targetClass, targetMaxQuantity, p.pk_property).pipe(operators.tap((/**
             * @param {?} x
             * @return {?}
             */
            function (x) {
        ...
        function (config, klass, targetMaxQuantity, parentProperty) {
            ...
            // TODO add this to sysConfigValue
                ...
                return this.pipeBasicAndSpecificFields(klass.pk_class).pipe(operators.map((/**
                 * @param {?} fields
                 * @return {?}
                 */
                function (fields) {
       ...
       */
        ...
        function (stmt, page, subfieldType) {
            ...
            if (subfieldType.appellation) {
                ...
                return this.s.inf$.place$.by_pk_entity$.key(targetInfo).pipe(operators.map((/**
                 * @param {?} place
                 * @return {?}
                 */
                function (place) {
                ...
                return this.s.inf$.dimension$.by_pk_entity$.key(targetInfo).pipe(operators.switchMap((/**
                 * @param {?} dimension
                 * @return {?}
                 */
                function (dimension) {
                ...
                return this.s.inf$.lang_string$.by_pk_entity$.key(targetInfo).pipe(operators.switchMap((/**
                 * @param {?} langString
                 * @return {?}
                 */
                function (langString) {
                ...
                return this.s.inf$.language$.by_pk_entity$.key(targetInfo).pipe(operators.map((/**
                 * @param {?} language
                 * @return {?}
                 */
                function (language) {
                ...
                return this.p.streamEntityPreview(targetInfo).pipe(operators.map((/**
                 * @param {?} entityPreview
                 * @return {?}
                 */
                ...
                function (fkProperty) {
                    ...
                    return _this.pipeSubfieldPage(nestedPage, subfType).pipe(operators.map((/**
                     * @param {?} __0
                     * @return {?}
                     */
                    function (_a) {
                ...
                return this.s.inf$.time_primitive$.by_pk_entity$.key(targetInfo).pipe(operators.switchMap((/**
                 * @param {?} timePrimitive
                 * @return {?}
                 */
        ...
        function (page, subfieldType) {
            ...
            if (subfieldType.timeSpan) {
                 ...
                 * @return {?}
                 */
                function (stmt) { return _this.pipeStatementWithTarget(stmt, page, subfieldType); }))); }))); })))).pipe(operators.map((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
        ...
        function (page, subfieldType) {
            ...
            return this.pipeTargetOfStatement(virtualStatementToTimeSpan, page, subfieldType).pipe(operators.map((/**
             * @param {?} stmtTarget
             * @return {?}
             */
            function (stmtTarget) {
