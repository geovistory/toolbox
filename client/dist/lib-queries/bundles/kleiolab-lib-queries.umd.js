(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function timeSpanItemToTimeSpan(timeSpanItem) {
        ...
        function (p) {
            /** @type {?} */
            var key = libConfig.DfhConfig.PROPERTY_PK_TO_EXISTENCE_TIME_KEY[p.listDefinition.property.fkProperty];
        ...
        */
                    ...
                    try {
                        ...
                        for (var subfields_1 = __values(subfields), subfields_1_1 = subfields_1.next(); !subfields_1_1.done; subfields_1_1 = subfields_1.next()) {
                            ...
                            if (!uniqFields[fieldId]) {
                                ...
                                else if (s.property.fkProperty === libConfig.DfhConfig.PROPERTY_PK_HAS_TIME_SPAN)
        ...
        function (pkClass, noNesting) {
            ...
            function (allFields) {
                 ...
                 * @return {?}
                 */
                function (field) { return field.property.fkProperty === libConfig.DfhConfig.PROPERTY_PK_HAS_TIME_SPAN; }));
                if (whenField)
    ...
    var InformationPipesService = /** @class */ (function () {
        ...
        function (page, targets) {
            var _this = this;
            if (page.property.fkProperty === libConfig.DfhConfig.PROPERTY_PK_HAS_TIME_SPAN && page.isOutgoing) {
