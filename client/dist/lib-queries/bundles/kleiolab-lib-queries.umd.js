(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular-redux/store'), require('@kleiolab/lib-sockets'), require('ramda'), require('rxjs'), require('rxjs/operators'), require('rxjs-spy/operators'), require('@kleiolab/lib-redux'), require('@kleiolab/lib-utils'), require('d3'), require('@kleiolab/lib-config'), require('@kleiolab/lib-sdk-lb3')) :
    typeof define === 'function' && define.amd ? define('@kleiolab/lib-queries', ['exports', '@angular/common', '@angular/core', '@angular-redux/store', '@kleiolab/lib-sockets', 'ramda', 'rxjs', 'rxjs/operators', 'rxjs-spy/operators', '@kleiolab/lib-redux', '@kleiolab/lib-utils', 'd3', '@kleiolab/lib-config', '@kleiolab/lib-sdk-lb3'], factory) :
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-queries'] = {}), global.ng.common, global.ng.core, global.store, global.libSockets, global.ramda, global.rxjs, global.rxjs.operators, global.operators$1, global.libRedux, global.libUtils, global.d3, global.libConfig, global.libSdkLb3));
}(this, (function (exports, common, core, store, libSockets, ramda, rxjs, operators, operators$1, libRedux, libUtils, d3, libConfig, libSdkLb3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Selector = /** @class */ (function () {
        ...
        function (indexKey) {
            var _this = this;
            /** @type {?} */
            var all$ = this.pkProject$.pipe(operators.switchMap((/**
             * @param {?} pk
             * @return {?}
             */
            function (pk) {
                ...
                if (_this.configs[_this.model].facetteByPk) {
                    path = [libRedux.infRoot, _this.model, _this.configs[_this.model].facetteByPk, pk, indexKey];
                }
                else {
                    path = [libRedux.infRoot, _this.model, indexKey];
                }
             ...
             */
            function (x) {
                return _this.pkProject$.pipe(operators.switchMap((/**
                 * @param {?} pk
                 * @return {?}
                 */
                function (pk) {
                    ...
                    var path;
                    if (_this.configs[_this.model].facetteByPk) {
                        path = [libRedux.infRoot, _this.model, _this.configs[_this.model].facetteByPk, pk, indexKey, x];
                    }
                    else {
                        path = [libRedux.infRoot, _this.model, indexKey, x];
                    }
                    return _this.ngRedux.select(path);
                })));
            });
    ...
    var ActiveProjectPipesService = /** @class */ (function () {
        function ActiveProjectPipesService(ngRedux, s, entityPreviewSocket) {
            ...
            this.pkProject$ = ngRedux.select(['activeProject', 'pk_project']).pipe(operators.filter((/**
             * @param {?} p
             * @return {?}
             */
            function (p) { return p !== undefined; })), operators.distinctUntilChanged((/**
    ...
    var ConfigurationPipesService = /** @class */ (function () {
        ...
        */
        ...
        function () {
             ...
             * @return {?}
             */
            function (enabled) { return __spread(enabled, [libConfig.DfhConfig.PK_PROFILE_GEOVISTORY_BASIC]); }))); })));
        };
        /**
        ...
        function (pkClass) {
            ...
            function (_a) {
                ...
                if (pkClass !== libConfig.DfhConfig.CLASS_PK_APPELLATION_FOR_LANGUAGE) {
                ...
                return rxjs.combineLatest(_this.pipePropertiesToSubfields(outgoingProps, true, enabledProfiles, sysConfig), _this.pipePropertiesToSubfields(ingoingProps, false, enabledProfiles, sysConfig), _this.pipeFieldConfigs(pkClass)).pipe(operators.map((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
         ...
         */
        function (pkClass) {
            return this.pipeFields(pkClass).pipe(operators.map((/**
             * @param {?} fields
             * @return {?}
             */
         ...
         */
        function (pkClass) {
            return rxjs.combineLatest(this.pipeBasicFieldsOfClass(pkClass), this.pipeSpecificFieldOfClass(pkClass))
                .pipe(operators.map((/**
             * @param {?} __0
             * @return {?}
             */
        ...
        */
         ...
         */
        function (pkClass) {
            return rxjs.combineLatest(this.pipeSpecificFieldOfClass(pkClass), this.pipeBasicFieldsOfClass(pkClass))
                .pipe(operators.map((/**
             * @param {?} __0
             * @return {?}
             */
        ...
        function (properties, isOutgoing, enabledProfiles, sysConfig) {
            ...
            function (p) {
                ...
                var sourceMinQuantity = o ?
                    p.domain_instances_min_quantifier :
                    p.range_instances_min_quantifier;
                return rxjs.combineLatest(_this.pipeClassLabel(sourceClass), _this.pipeClassLabel(targetClass), _this.pipeSubfieldTypeOfClass(sysConfig, targetClass, targetMaxQuantity), _this.pipeFieldLabel(p.pk_property, isOutgoing ? p.has_domain : null, isOutgoing ? null : p.has_range)).pipe(operators.map((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
        ...
        function (config, pkClass, targetMaxQuantity) {
             ...
             * @return {?}
             */
            function (i) { return !!i; })), operators.map((/**
             * @param {?} klass
             * @return {?}
             */
    ...
    function createAppellationProperty(rangeClass) {
        ...
        /** @type {?} */
        var hasAppeProp = {
            has_domain: libConfig.DfhConfig.CLASS_PK_APPELLATION_FOR_LANGUAGE,
            pk_property: libConfig.DfhConfig.PROPERTY_PK_IS_APPELLATION_OF,
    ...
    var InformationPipesService = /** @class */ (function () {
        ...
        function (l, pkEntity) {
            switch (l.listType) {
                ...
                case 'temporal-entity':
                    return this.pipeList(l, pkEntity).pipe(operators.map((/**
                     * @param {?} items
                     * @return {?}
                     */
                    function (items) { return items.length; })));
                case 'time-span':
                    return rxjs.combineLatest(this.b.pipeOutgoingStatementsByProperty(72, pkEntity), this.b.pipeOutgoingStatementsByProperty(71, pkEntity), this.b.pipeOutgoingStatementsByProperty(150, pkEntity), this.b.pipeOutgoingStatementsByProperty(151, pkEntity), this.b.pipeOutgoingStatementsByProperty(152, pkEntity), this.b.pipeOutgoingStatementsByProperty(153, pkEntity)).pipe(operators.tap((/**
                     * @param {?} x
                     * @return {?}
                     */
                    function (x) {
                ...
                default:
                    ...
                    return new rxjs.BehaviorSubject(0);
            }
        };
        /**
         * @param {?} l
        ...
        function (l, pkEntity, limit) {
            if (l.listType.appellation)
                ...
                return this.pipeItemTimeSpan(pkEntity).pipe(operators.map((/**
                 * @param {?} ts
                 * @return {?}
                 */
        ...
        function (listDefinition, pkEntity, limit) {
             ...
             */
            function (statements) {
                return rxjs.combineLatest(statements.map((/**
                 * @param {?} r
                 * @param {?} i
                 * @return {?}
                 */
                 ...
                 * @return {?}
                 */
                function (node) { return !!node && node.fkClass === listDefinition.targetClass; })); })), libUtils.limitTo(limit), operators.startWith([]));
            })));
        };
        /**
       ...
       */
        ...
        function (listDefinition, pkEntity, limit) {
            var _this = this;
            return this.b.pipeStatementsOfList(listDefinition, pkEntity)
                .pipe(operators$1.tag("before-" + pkEntity + "-" + listDefinition.property.pkProperty + "-" + listDefinition.targetClass), operators.switchMap((/**
             * @param {?} statements
             * @return {?}
             */
            function (statements) {
                 ...
                 * @return {?}
                 */
                function (a, b) { return a.ordNum > b.ordNum ? 1 : -1; })); }), libUtils.limitTo(limit)), operators.startWith([]));
            })), operators$1.tag("after-" + pkEntity + "-" + listDefinition.property.pkProperty + "-" + listDefinition.targetClass));
        };
        /**
         * @template T
         * @param {?} listDefinition
       ...
       */
        ...
        function (pkEntity, fieldDefinitions, pkProject, repo) {
            ...
            /** @type {?} */
            var outgoingItems$ = outgoingStatements$.pipe(operators.switchMap((/**
             * @param {?} statements
             * @return {?}
             */
            function (statements) { return libUtils.combineLatestOrEmpty(statements
                .filter((/**
             * @param {?} statement
             * @return {?}
             */
            ...
            /** @type {?} */
            var ingoingItems$ = ingoingStatements$.pipe(operators.switchMap((/**
             * @param {?} statements
             * @return {?}
             */
            function (statements) { return libUtils.combineLatestOrEmpty(statements
            ...
            var sortItems = repo ?
                 ...
                 */
                function (item) { return item; });
            return rxjs.combineLatest(outgoingItems$, ingoingItems$).pipe(operators.map((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
                ...
                function (fieldDefinition) {
                    ...
                    function (listDefinition) {
                        if (listDefinition.listType.timeSpan) {
                            /** @type {?} */
                            var t_1 = ramda.pick(['71', '72', '150', '151', '152', '153'], d.groupedOut);
                            /** @type {?} */
                            ...
                            if (itemsCount > 0) {
                                ...
                                /** @type {?} */
                                var timeSpan = libUtils.TimeSpanUtil.fromTimeSpanDialogData(timeSpanKeys_1);
        ...
        function (r, pkProject, propIsOutgoing) {
            ...
            return this.s.inf$.getModelOfEntity$(targetEntity).pipe(operators.switchMap((/**
             * @param {?} m
             * @return {?}
             */
            function (m) {
         ...
         */
        function (pkEntity) {
            return rxjs.combineLatest(this.s.inf$.temporal_entity$.by_pk_entity_key$(pkEntity), this.s.inf$.statement$.by_subject$({ fk_subject_info: pkEntity }), this.s.inf$.text_property$.by_fk_concerned_entity_indexed$(pkEntity)).pipe(operators.map((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
                ...
                var res = {
                    ...
                    textProperties: ramda.values(textProperties)
                };
                return res;
            })));
        };
        ...
        function (pkEntity) {
            var _this = this;
            return this.p.pkProject$.pipe(operators.switchMap((/**
             * @param {?} pkProject
             * @return {?}
             */
            function (pkProject) {
                return _this.c.pipeSpecificFieldOfClass(libConfig.DfhConfig.ClASS_PK_TIME_SPAN).pipe(operators.switchMap((/**
                 * @param {?} fieldDefs
                 * @return {?}
                 */
                function (fieldDefs) {
                    return rxjs.combineLatest(fieldDefs.map((/**
                     * @param {?} fieldDef
                     * @return {?}
                     */
                    function (fieldDef) { return _this.s.inf$.statement$.by_subject_and_property$({
                        ...
                        .pipe(libUtils.switchMapOr([], (/**
                     * @param {?} statements
                     * @return {?}
                     */
                    function (statements) { return rxjs.combineLatest(statements.map((/**
                     * @param {?} statement
                     * @return {?}
                     */
                    function (statement) { return rxjs.combineLatest(_this.s.inf$.time_primitive$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
                     * @param {?} x
                     * @return {?}
                     */
                    function (x) { return !!x; }))), _this.s.pro$.info_proj_rel$.by_fk_project__fk_entity$.key(pkProject + '_' + statement.pk_entity)).pipe(operators.map((/**
                     * @param {?} __0
                     * @return {?}
                     */
                    function (_a) {
                        ...
                        /** @type {?} */
                        var timePrimitive = new libUtils.TimePrimitive({
                            julianDay: infTimePrimitive.julian_day,
         ...
         */
        function (statement) {
            return this.s.inf$.appellation$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
             * @param {?} x
             * @return {?}
             */
            function (x) { return !!x; })), operators.map((/**
         ...
         */
        function (statement) {
            return this.s.inf$.language$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
             * @param {?} x
             * @return {?}
             */
            function (x) { return !!x; })), operators.map((/**
         ...
         */
        function (statement) {
            return this.s.inf$.place$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
             * @param {?} x
             * @return {?}
             */
            function (x) { return !!x; })), operators.map((/**
        ...
        function (statement) {
            var _this = this;
            return this.s.inf$.dimension$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
             * @param {?} x
             * @return {?}
             */
            function (x) { return !!x; })), operators.switchMap((/**
        ...
        function (statement) {
            var _this = this;
            return this.s.inf$.lang_string$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.switchMap((/**
             * @param {?} langString
             * @return {?}
             */
            function (langString) {
        ...
        function (statement, pkProject) {
            var _this = this;
            if (pkProject) {
                return rxjs.combineLatest(this.s.inf$.time_primitive$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
                 * @param {?} x
                 * @return {?}
                 */
                function (x) { return !!x; }))), this.s.pro$.info_proj_rel$.by_fk_project__fk_entity$.key(pkProject + '_' + statement.pk_entity).pipe(operators.filter((/**
                 * @param {?} x
                 * @return {?}
                 */
                function (x) { return !!x; })))).pipe(operators.map((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
                ...
                return this.infRepo.time_primitive$.by_pk_entity$.key(statement.fk_object_info).pipe(operators.filter((/**
                 * @param {?} x
                 * @return {?}
                 */
                function (x) { return !!x; }))).pipe(operators.map((/**
        ...
        *********************************************************************/
        ...
        function (l, pkEntity) {
            switch (l.listType) {
                ...
                case 'temporal-entity':
                case 'time-span':
                    return this.pipeAltListStatements(l, pkEntity).pipe(operators.map((/**
                     * @param {?} items
                     * @return {?}
                     */
                    function (items) { return items.length; })));
        ...
        */
        ...
        function (listDefinition, pkEntity) {
            ...
            return (listDefinition.isOutgoing ?
                ...
                this.b.pipeAlternativeIngoingStatements(listDefinition.property.pkProperty, pkEntity)).pipe(operators.switchMap((/**
             * @param {?} statements
             * @return {?}
             */
            function (statements) {
                 ...
                 * @return {?}
                 */
                function (a, b) { return a.ordNum > b.ordNum ? 1 : -1; })); })), operators.startWith([]));
            })));
        };
        /**
        ...
        function (listDefinition, pkEntity) {
            var _this = this;
            if (listDefinition.isOutgoing) {
                return this.b.pipeAlternativeOutgoingStatements(listDefinition.property.pkProperty, pkEntity).pipe(operators.switchMap((/**
                 * @param {?} statements
                 * @return {?}
                 */
                function (statements) {
                     ...
                     * @return {?}
                     */
                    function (node) { return !!node && node.fkClass === listDefinition.targetClass; })); })), operators.startWith([]));
                })));
            }
        };
        /**
        ...
        function (listDefinition, pkEntity) {
            var _this = this;
            if (listDefinition.isOutgoing) {
                return this.b.pipeRepoOutgoingStatementsByProperty(listDefinition.property.pkProperty, pkEntity).pipe(operators.switchMap((/**
                 * @param {?} statements
                 * @return {?}
                 */
                function (statements) {
        ...
        */
        ...
        function (listDefinition, pkEntity) {
            ...
            return (listDefinition.isOutgoing ?
                ...
                this.b.pipeRepoIngoingStatementsByProperty(listDefinition.property.pkProperty, pkEntity)).pipe(operators.switchMap((/**
             * @param {?} statements
             * @return {?}
             */
            function (statements) {
        ...
        function (pkEntity) {
             ...
             */
            function (pkProject) {
                return _this.c.pipeBasicAndSpecificFields(libConfig.DfhConfig.ClASS_PK_TIME_SPAN).pipe(operators.switchMap((/**
                 * @param {?} fieldDefinitions
                 * @return {?}
                 */
                function (fieldDefinitions) {
                    return rxjs.combineLatest(fieldDefinitions.map((/**
                     * @param {?} fieldDef
                     * @return {?}
                     */
                    function (fieldDef) {
                        ...
                        function (items) {
                            ...
                            return res;
                        })), operators.startWith((/** @type {?} */ ({ listDefinition: fieldDef.listDefinitions[0], items: [] }))));
                    }))).pipe(operators.map((/**
                     * @param {?} properties
                     * @return {?}
                     */
        ...
        function (fkEntity) {
             ...
             * @return {?}
             */
            function (fieldDef) { return libUtils.combineLatestOrEmpty(fieldDef && fieldDef.length ?
        ...
        __decorate([
            spyTag,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [libSdkLb3.InfStatement, Number, Boolean]),
            __metadata("design:returntype", void 0)
        ...
        __decorate([
            spyTag,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [libSdkLb3.InfStatement]),
            __metadata("design:returntype", rxjs.Observable)
        ...
        __decorate([
            spyTag,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [libSdkLb3.InfStatement, Boolean]),
            __metadata("design:returntype", rxjs.Observable)
        ], InformationPipesService.prototype, "pipeItemEntityPreview", null);
        __decorate([
            spyTag,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [libSdkLb3.InfStatement, Object]),
            __metadata("design:returntype", rxjs.Observable)
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/queries/models/SubfieldType.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    /**
     * @record
...
//# sourceMappingURL=kleiolab-lib-queries.umd.js.map
