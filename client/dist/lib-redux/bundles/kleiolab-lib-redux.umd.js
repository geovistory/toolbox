(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@kleiolab/lib-redux', ['exports', '@angular-redux/store', '@angular/core', '@kleiolab/lib-utils', 'rxjs/operators', '@kleiolab/lib-sdk-lb3', 'redux-observable-es6-compat', 'rxjs', '@kleiolab/lib-config', '@cime/ngx-slim-loading-bar', '@cime/ngx-toasty', '@angular/cdk/drag-drop', 'ramda'], factory) :
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-redux'] = {}), global.store, global.ng.core, global.libUtils, global.rxjs.operators, global.libSdkLb3, global.reduxObservableEs6Compat, global.rxjs, global.libConfig, global.ngxSlimLoadingBar, global.ngxToasty, global.ng.cdk['drag-drop'], global.ramda));
