(function (global, factory) {
    ...
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-redux'] = global.kleiolab['lib-redux'] || {}, global.kleiolab['lib-redux'].src = global.kleiolab['lib-redux'].src || {}, global.kleiolab['lib-redux'].src.lib = global.kleiolab['lib-redux'].src.lib || {}, global.kleiolab['lib-redux'].src.lib['redux-store'] = {}), global.store, global.ng.core, global.ngxSlimLoadingBar, global.ngxToasty, global.libSdkLb3, global.libSdkLb4, global.ramda, global.dynamicMiddlewares, global.reduxObservableEs6Compat, global.rxjs, global.rxjs.operators, global.libConfig, global.libUtils, global.slimLoadingBar_service, global.toasty_service, global.form, global.router, global.redux, global.ng.cdk['drag-drop']));
...
;
    ...
    var SchemaService = /** @class */ (function () {
        ...
        SchemaService.ctorParameters = function () { return [
            { type: libSdkLb3.SchemaObjectApi },
            { type: InfActions },
            { type: ProActions },
            { type: DatActions },
            { type: WarActions },
        ...
        /** @nocollapse */ SchemaService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function SchemaService_Factory() { return new SchemaService(core.ɵɵinject(libSdkLb3.SchemaObjectApi), core.ɵɵinject(InfActions), core.ɵɵinject(ProActions), core.ɵɵinject(DatActions), core.ɵɵinject(WarActions), core.ɵɵinject(TabActions), core.ɵɵinject(DfhActions), core.ɵɵinject(SysActions), core.ɵɵinject(NotificationsAPIActions)); }, token: SchemaService, providedIn: "root" });
    ...
    var ActiveProjectEpics = /** @class */ (function () {
               ...
               */
                ...
                function (data) {
                    ...
                    _this.schemaObj.storeSchemaObject({
                        ...
                        pro: { project: [ramda.omit(['default_language'], data[0])] }
        ...
        */
        ...
        /** @nocollapse */ ActiveProjectEpics.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ActiveProjectEpics_Factory() { return new ActiveProjectEpics(core.ɵɵinject(SysActions), core.ɵɵinject(DatActions), core.ɵɵinject(DfhActions), core.ɵɵinject(ProActions), core.ɵɵinject(InfActions), core.ɵɵinject(libSdkLb3.ProProjectApi), core.ɵɵinject(ActiveProjectActions), core.ɵɵinject(NotificationsAPIActions), core.ɵɵinject(LoadingBarActions), core.ɵɵinject(store.NgRedux), core.ɵɵinject(SchemaService)); }, token: ActiveProjectEpics, providedIn: "root" });
    ...
    ModelFlattener = /** @class */ (function () {
        ...
        function (items) {
            if (items && items.length > 0) {
                ...
                /** @type {?} */
                var keysToOmit_1 = ramda.keys(this.modelDefinition.relations).map((/**
                 * @param {?} item
                 * @return {?}
                 */
                 ...
                 * @return {?}
                 */
                function (item) { return ramda.omit(keysToOmit_1, item); })))));
            }
            return true;
        };
    ...
    Flattener = /** @class */ (function () {
        function Flattener(infActions, datActions, proActions) {
            ...
            this.datActions = datActions;
            this.proActions = proActions;
            this.info_proj_rel = new ModelFlattener(this.proActions.info_proj_rel, libSdkLb3.ProInfoProjRel.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.ProInfoProjRel(item);
                }));
            }));
            this.pro_dfh_class_proj_rel = new ModelFlattener(this.proActions.dfh_class_proj_rel, libSdkLb3.ProDfhClassProjRel.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.ProDfhClassProjRel(item);
                }));
            }));
            this.pro_dfh_profile_proj_rel = new ModelFlattener(this.proActions.dfh_profile_proj_rel, libSdkLb3.ProDfhProfileProjRel.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.ProDfhProfileProjRel(item);
                }));
            }));
            this.persistent_item = new ModelFlattener(this.infActions.persistent_item, libSdkLb3.InfPersistentItem.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfPersistentItem(item);
            ...
            this.temporal_entity = new ModelFlattener(this.infActions.temporal_entity, libSdkLb3.InfTemporalEntity.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfTemporalEntity(item);
                    _this.statement.flatten(item.outgoing_statements);
                    _this.statement.flatten(item.incoming_statements);
                    _this.text_property.flatten(item.text_properties);
                    _this.info_proj_rel.flatten(item.entity_version_project_rels);
            ...
            this.statement = new ModelFlattener(this.infActions.statement, libSdkLb3.InfStatement.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfStatement(item);
                    _this.info_proj_rel.flatten(item.entity_version_project_rels);
                    // Subject
            ...
            this.appellation = new ModelFlattener(this.infActions.appellation, libSdkLb3.InfAppellation.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfAppellation(item);
                }));
            }));
            this.place = new ModelFlattener(this.infActions.place, libSdkLb3.InfPlace.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfPlace(item);
                }));
            }));
            this.time_primitive = new ModelFlattener(this.infActions.time_primitive, libSdkLb3.InfTimePrimitive.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfTimePrimitive(item);
                }));
            }));
            this.language = new ModelFlattener(this.infActions.language, libSdkLb3.InfLanguage.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfLanguage(item);
                }));
            }));
            this.lang_string = new ModelFlattener(this.infActions.lang_string, libSdkLb3.InfLangString.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfLangString(item);
                    _this.language.flatten([item.language]);
                    _this.info_proj_rel.flatten(item.entity_version_project_rels);
                }));
            }));
            this.dimension = new ModelFlattener(this.infActions.dimension, libSdkLb3.InfDimension.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfDimension(item);
                    _this.info_proj_rel.flatten(item.entity_version_project_rels);
                }));
            }));
            this.text_property = new ModelFlattener(this.infActions.text_property, libSdkLb3.InfTextProperty.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.InfTextProperty(item);
                    _this.language.flatten([item.language]);
                    _this.info_proj_rel.flatten(item.entity_version_project_rels);
                }));
            }));
            this.digital = new ModelFlattener(this.datActions.digital, libSdkLb3.DatDigital.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.DatDigital(item);
                }));
            }));
            this.chunk = new ModelFlattener(this.datActions.chunk, libSdkLb3.DatChunk.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.DatChunk(item);
                    _this.statement.flatten(item.outgoing_statements);
                }));
            }));
            this.pro_project = new ModelFlattener(this.proActions.project, libSdkLb3.ProProject.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.ProProject(item);
                    _this.language.flatten([item.default_language]);
                }));
            }));
            this.pro_text_property = new ModelFlattener(this.proActions.text_property, libSdkLb3.ProTextProperty.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.ProTextProperty(item);
                    _this.language.flatten([item.language]);
                }));
            }));
            this.pro_class_field_config = new ModelFlattener(this.proActions.class_field_config, libSdkLb3.ProClassFieldConfig.getModelDefinition(), (/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
                 ...
                 */
                function (item) {
                    item = new libSdkLb3.ProClassFieldConfig(item);
                }));
            }));
    ...
    function (flattened, pk, type) {
        ramda.values(flattened).forEach((/**
         * @param {?} model
         * @return {?}
         */
        function (model) {
    ...
    InfEpicsFactory = /** @class */ (function (_super) {
        ...
        function (apiFn, onSuccessHook) {
            ...
            function (action$, store) {
                ...
                function (globalActions) {
                     ...
                     * @return {?}
                     */
                    function (i) { return (__assign({}, i, { entity_version_project_rels: [__assign({}, ramda.pathOr({}, ['entity_version_project_rels', 0], i), { is_in_project: true })] })); }));
                    apiFn(meta).subscribe((/**
                     * @param {?} data
                     * @return {?}
                     */
        ...
        function () {
             ...
             */
            function (action$, store) {
                return action$.pipe(reduxObservableEs6Compat.ofType(_this.actionPrefix + '.' + _this.modelName + '::REMOVE'), operators.mergeMap((/**
                 * @param {?} action
                 * @return {?}
                 */
                function (action) { return new rxjs.Observable((/**
        ...
        function (apiFn, actionSuffix, onSuccessHook) {
             ...
             */
            function (action$, store) {
                return action$.pipe(reduxObservableEs6Compat.ofType(_this.actionPrefix + '.' + _this.modelName + '::UPSERT' + (actionSuffix ? '::' + actionSuffix : '')), operators.mergeMap((/**
                 * @param {?} action
                 * @return {?}
                 */
                function (action) { return new rxjs.Observable((/**
    ...
    var InfEpics = /** @class */ (function () {
        ...
        function () {
             ...
             * @return {?}
             */
            function (action$, store) { return action$.pipe(reduxObservableEs6Compat.ofType(infTemporalEntityEpicsFactory.type('LOAD', InfTemporalEntityActionFactory.PAGINATED_LIST)), operators.mergeMap((/**
             * @param {?} action
             * @return {?}
             */
            function (action) { return new rxjs.Observable((/**
             ...
             * @return {?}
             */
            function (action$, store) { return action$.pipe(reduxObservableEs6Compat.ofType(infTemporalEntityEpicsFactory.type('LOAD', InfTemporalEntityActionFactory.PAGINATED_ALTERNATIVE_LIST)), operators.mergeMap((/**
             * @param {?} action
             * @return {?}
             */
            function (action) { return new rxjs.Observable((/**
             ...
             * @return {?}
             */
            function (action$, store) { return action$.pipe(reduxObservableEs6Compat.ofType(infStatementEpicsFactory.type('LOAD', InfTemporalEntityActionFactory.PAGINATED_LIST)), operators.mergeMap((/**
             * @param {?} action
             * @return {?}
             */
            function (action) { return new rxjs.Observable((/**
        ...
        InfEpics.ctorParameters = function () { return [
            { type: NotificationsAPIActions },
            { type: libSdkLb3.InfPersistentItemApi },
            { type: libSdkLb3.InfTemporalEntityApi },
            { type: libSdkLb3.InfStatementApi },
            { type: libSdkLb3.InfTextPropertyApi },
            { type: InfActions },
            { type: ProActions },
            { type: DatActions },
    ...
    var GvSchemaActions = /** @class */ (function () {
       ...
       */
        ...
        /** @nocollapse */ GvSchemaActions.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function GvSchemaActions_Factory() { return new GvSchemaActions(core.ɵɵinject(store.NgRedux)); }, token: GvSchemaActions, providedIn: "root" });
    ...
    var SchemaEpics = /** @class */ (function () {
        ...
        function () {
             ...
             * @return {?}
             */
            function (action$, store) { return action$.pipe(reduxObservableEs6Compat.ofType(GvSchemaActions.GV_SCHEMA_OBJECT_LOAD), operators.mergeMap((/**
             * @param {?} action
             * @return {?}
             */
            function (action) { return new rxjs.Observable((/**
            ...
            */
             ...
             * @return {?}
             */
            function (action$, store) { return action$.pipe(reduxObservableEs6Compat.ofType(GvSchemaActions.GV_PAGINATION_OBJECT_LOAD), operators.mergeMap((/**
             * @param {?} action
             * @return {?}
             */
            function (action) { return new rxjs.Observable((/**
    ...
    var RootEpics = /** @class */ (function () {
        function RootEpics(loadingBarEpics, notificationEpics, activeProjectEpics, accountEpics, sysEpics, dfhEpics, infEpics, datEpics, proEpics, schemaObjectEpics, actionResolver) {
            ...
            function (action$, state$, dependencies) {
                ...
                return _this.rootEpicStream$.pipe(operators.mergeMap((/**
                 * @param {?} epic
                 * @return {?}
                 */
    ...
    function subfieldIdToString(x) {
        ...
        return source + "_" + property + "_" + (x.isOutgoing ? 'out' : 'in') + "_" + ramda.keys(x.scope)[0] + "_" + ramda.values(x.scope)[0];
    }
    ...
    ReducerFactory = /** @class */ (function () {
        ...
        function () {
            ...
            /** @type {?} */
            var reducers = {};
            libUtils.U.obj2KeyValueArr(this.configs).forEach((/**
             * @param {?} x
             * @return {?}
             */
            function (x) {
            ...
            /** @type {?} */
            var entityModelMapReducers = ramda.keys(this.configs).map((/**
             * @param {?} modelName
             * @return {?}
             */
            function (modelName) { return _this.createEntityModelMapReducers(modelName); }));
            reducers[PR_ENTITY_MODEL_MAP] = form.composeReducers.apply(void 0, __spread(entityModelMapReducers));
        ...
        function (modelName, config) {
            ...
            function (state, action) {
                ...
                if (action.type === actionPrefix + '.' + modelName + '::LOAD') {
                     ...
                     * @return {?}
                     */
                    function (innerState) { return (__assign({}, ramda.omit([by(config.indexBy.keyInStore)], innerState), { loading: true })); }));
                }
                    ...
                    function (innerState) {
                        ...
                        // , true
                        ), (_a = {}, _a[_this.updatingBy(config.indexBy.keyInStore)] = ramda.omit(ramda.values(_this.indexKeyObject(action, config)), innerState[_this.updatingBy(config.indexBy.keyInStore)]), _a)));
                    }));
                }
                    ...
                    function (innerState) {
                        var _a;
                        innerState = __assign({}, _this.deleteItemsFromState(config, action, innerState), (_a = {}, _a[deletingKey_1] = ramda.omit(ramda.values(_this.indexKeyObject(action, config)), innerState[_this.deletingBy(config.indexBy.keyInStore)]), _a));
                        if (!Object.keys(innerState[deletingKey_1]).length)
                            innerState = ramda.omit([deletingKey_1], innerState);
                        return innerState;
                    }));
                }
                    ...
                    function (innerState) {
                        var _a;
                        innerState = __assign({}, _this.deleteItemsFromState(config, action, innerState), (_a = {}, _a[removingKey_1] = ramda.omit(ramda.values(_this.indexKeyObject(action, config)), innerState[_this.removingBy(config.indexBy.keyInStore)]), _a));
                        if (!Object.keys(innerState[removingKey_1]).length)
                            innerState = ramda.omit([removingKey_1], innerState);
                        return innerState;
                    }));
                }
                     ...
                     * @return {?}
                     */
                    function (innerState) { return (__assign({}, innerState, ramda.omit([by(config.indexBy.keyInStore)], innerState), { loading: false })); }));
                }
            ...
            function (state, action) {
                ...
                switch (action.type) {
                    ...
                    case modelPath + '::REMOVE_SUCCEEDED':
                        ...
                        state = ramda.omit(pkEntities, state);
                        break;
                    default:
                        break;
                }
        ...
        function (config, action, state) {
            ...
            function (removedItem) {
                ...
                if (oldItem) {
                    ...
                    state = __assign({}, state, (_a = {}, _a[mainIndexKey] = __assign({}, ramda.omit([itemKey], state[mainIndexKey])), _a));
                    ...
                    function (g) {
                        ...
                        state = __assign({}, state, (_a = {}, _a[g.groupByKey] = __assign({}, state[g.groupByKey], (_b = {}, _b[groupKey] = __assign({}, ramda.omit([itemKey], (state[g.groupByKey] || {})[groupKey])), _b)), _a));
                        // // cleanup paginations
            ...
            if (Object.keys(state[mainIndexKey]).length < 1) {
                state = __assign({}, ramda.omit([mainIndexKey], state));
            }
            ...
            function (g) {
                ...
                function (groupKey) {
                    ...
                    if (Object.keys(state[g.groupByKey][groupKey]).length < 1) {
                        state = __assign({}, state, (_a = {}, _a[g.groupByKey] = ramda.omit([groupKey], state[g.groupByKey]), _a));
                    }
                }));
                // cleanup group index
                if (Object.keys(state[g.groupByKey]).length < 1) {
                    state = __assign({}, ramda.omit([g.groupByKey], state));
                }
            }));
            return state;
        };
        ...
        // , resetPaginations = false
            ...
            function (newItem) {
                ...
                /** @type {?} */
                var equalsFn = config.equals || ramda.equals;
                if (oldItem && equalsFn(newItem, oldItem)) {
                    ...
                    function (g) {
                        ...
                        state = __assign({}, state, (_a = {}, _a[g.groupByKey] = __assign({}, state[g.groupByKey], (_b = {}, _b[oldGroupKey] = __assign({}, ramda.omit([itemKey], (state[g.groupByKey] || {})[oldGroupKey])), _b)), _a));
    ...
    function (state, action) {
        ...
        if (action && action.meta && action.meta.removePending) {
            ...
            state = __assign({}, ramda.omit([uuid], state));
        }
        return state;
    });
    /** @type {?} */
    ...
    /** @type {?} */
    var rootReducer = form.composeReducers(form.defaultFormReducer(), redux.combineReducers({
        account: accountRootReducer,
        loadingBar: loadingBarReducer,
        activeProject: activeProjectReducer,
        routes: router.routerReducer,
        ...
        resolved: form.composeReducers(resolvedRequestReducer, cleanupResolved),
    }), setAppState);
    ...
    function (action) {
        ...
        /** @type {?} */
        var bool = ramda.equals(actionPath, path);
        return bool;
    }); });
    /** @type {?} */
    ...
    var ReduxModule = /** @class */ (function () {
        ...
        ReduxModule.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [APP_INITIAL_STATE,] }] }
        ]; };
        return ReduxModule;
    }());
    if (false) {
    ...
    exports.APP_INITIAL_STATE = APP_INITIAL_STATE;
    ...
    exports.GvSchemaActions = GvSchemaActions;
    exports.INIT_SANDBOX_STATE = INIT_SANDBOX_STATE;
    exports.InfActionFactory = InfActionFactory;
    exports.InfActions = InfActions;
    exports.InfAppellationSlice = InfAppellationSlice;
    exports.InfDimensionSlice = InfDimensionSlice;
    exports.InfEpicsFactory = InfEpicsFactory;
    ...
    exports.SchemaEpicsFactory = SchemaEpicsFactory;
    ...
    exports.by = by;
    exports.cleanupResolved = cleanupResolved;
    ...
    exports.createWarReducer = createWarReducer;
    exports.datDefinitions = datDefinitions;
    exports.datRoot = datRoot;
    exports.dfhDefinitions = dfhDefinitions;
    exports.dfhLabelByFksKey = dfhLabelByFksKey;
    exports.dfhRoot = dfhRoot;
    exports.facetteByPk = facetteByPk;
    exports.getEnd = getEnd;
    exports.getFromTo = getFromTo;
    exports.getStart = getStart;
    exports.indexStatementByObject = indexStatementByObject;
    exports.indexStatementByObjectProperty = indexStatementByObjectProperty;
    exports.indexStatementBySubject = indexStatementBySubject;
    ...
    exports.proRoot = proRoot;
    exports.resolvedRequestReducer = resolvedRequestReducer;
    ...
    exports.textPropertyByFksKey = textPropertyByFksKey;
    exports.textPropertyByFksWithoutLang = textPropertyByFksWithoutLang;
    exports.warDefinitions = warDefinitions;
    exports.warRoot = warRoot;
    exports.ɵa = LoadingBarEpics;
    exports.ɵb = NotificationsAPIEpics;
    exports.ɵc = ActiveProjectEpics;
    exports.ɵd = AccountEpics;
    exports.ɵe = SysEpics;
    exports.ɵf = DfhEpics;
    exports.ɵg = InfEpics;
    exports.ɵh = DatEpics;
    exports.ɵi = ProEpics;
    exports.ɵj = SchemaEpics;
