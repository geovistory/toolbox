(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-socket-io'), require('@kleiolab/lib-redux')) :
    typeof define === 'function' && define.amd ? define('@kleiolab/lib-sockets/src/lib/sockets', ['exports', '@angular/core', 'ngx-socket-io', '@kleiolab/lib-redux'], factory) :
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-sockets'] = global.kleiolab['lib-sockets'] || {}, global.kleiolab['lib-sockets'].src = global.kleiolab['lib-sockets'].src || {}, global.kleiolab['lib-sockets'].src.lib = global.kleiolab['lib-sockets'].src.lib || {}, global.kleiolab['lib-sockets'].src.lib.sockets = {}), global.ng.core, global.ngxSocketIo, global.libRedux));
}(this, (function (exports, core, ngxSocketIo, libRedux) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EntityPreviewSocket = /** @class */ (function (_super) {
        ...
        EntityPreviewSocket.ctorParameters = function () { return [
            { type: libRedux.WarActions },
            { type: SocketsConfig, decorators: [{ type: core.Optional }] }
        ]; };
...
//# sourceMappingURL=kleiolab-lib-sockets-src-lib-sockets.umd.js.map
