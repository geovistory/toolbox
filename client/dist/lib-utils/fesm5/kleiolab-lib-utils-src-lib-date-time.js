...
/**
 * @fileoverview added by tsickle
 * Generated from: classes/index.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */

/**
 * @fileoverview added by tsickle
 * Generated from: pipes/index.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
...
export { DateTimeCommons, DateTimeModule, GregorianDateTime, JulianDateTime, TimePrimitive, TimePrimitivePipe, TimeSpanPipe, TimeSpanUtil, x, TimePrimitivePipe as ɵa, TimeSpanPipe as ɵb };
//# sourceMappingURL=kleiolab-lib-utils-src-lib-date-time.js.map
