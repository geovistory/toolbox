(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@kleiolab/lib-utils/src/lib/time-span', ['exports', '@kleiolab/lib-utils/src/lib/date-time'], factory) :
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-utils'] = global.kleiolab['lib-utils'] || {}, global.kleiolab['lib-utils'].src = global.kleiolab['lib-utils'].src || {}, global.kleiolab['lib-utils'].src.lib = global.kleiolab['lib-utils'].src.lib || {}, global.kleiolab['lib-utils'].src.lib['time-span'] = {}), global.kleiolab['lib-utils'].src.lib['date-time']));
...
//# sourceMappingURL=kleiolab-lib-utils-src-lib-time-span.umd.js.map
