(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@kleiolab/lib-utils/src/lib/date-time', ['exports', '@angular/common', '@angular/core'], factory) :
    (global = global || self, factory((global.kleiolab = global.kleiolab || {}, global.kleiolab['lib-utils'] = global.kleiolab['lib-utils'] || {}, global.kleiolab['lib-utils'].src = global.kleiolab['lib-utils'].src || {}, global.kleiolab['lib-utils'].src.lib = global.kleiolab['lib-utils'].src.lib || {}, global.kleiolab['lib-utils'].src.lib['date-time'] = {}), global.ng.common, global.ng.core));
    ...
    ***************************************************************************** */
    ...
    exports.x = x;
    exports.ɵa = TimePrimitivePipe;
    exports.ɵb = TimeSpanPipe;
