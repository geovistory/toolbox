...
const sql_formatter_1 = tslib_1.__importDefault(require("sql-formatter"));
class SqlBuilder {
    constructor() {
        ...
        if (!column.ofRootTable) {
            ...
            column.queryPath.forEach((segment, index) => {
                ...
                // JOIN Presences
                    ...
                    this.joinGeoEntity(node, leftTableAlias, thisTableAlias, fkProject, this.froms);
                }
                // JOIN entities
