...
const get_table_page_sql_builder_1 = require("./get-table-page-sql-builder");
/**
...
class TableRemotes {
    ...
    getPage(fkProject, pkEntity, options) {
        ...
        const q = new get_table_page_sql_builder_1.GetTablePageSqlBuilder().buildQuery(fkProject, pkEntity, options);
