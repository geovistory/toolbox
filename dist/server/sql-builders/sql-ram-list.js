...
class SqlRamList extends sql_builder_lb_models_1.SqlBuilderLbModels {
     ...
     */
    create(fkProject, pkEntity, fkProperty) {
        const sql = `
...
exports.SqlRamList = SqlRamList;
//# sourceMappingURL=sql-ram-list.js.map