...
class SqlTemporalAddToProject extends sql_builder_lb_models_1.SqlBuilderLbModels {
    ...
    create(fkProject, pkEntity, accountId) {
      ...
      SELECT
        ...
        ${this.addParam(accountId)},
        true
      FROM  information.get_outgoing_roles_to_add (${this.addParam(pkEntity)},${this.addParam(fkProject)})
      UNION
      -- the text properties
      SELECT
        pk_entity,
      ...
      WHERE v_text_property.fk_concerned_entity= ${this.addParam(pkEntity)}
    `;
        utils_1.logSql(sql, this.params);
        return { sql, params: this.params };
    }
}
exports.SqlTemporalAddToProject = SqlTemporalAddToProject;
//# sourceMappingURL=sql-temporal-add-to-project.js.map